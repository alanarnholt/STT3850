...
:::{.callout-important title="Course Texts & Materials"}
...
* 35% of the course grade will come from Problem Sets (9).  See the grading rubric on the [Course Pacing Guide](https://alanarnholt.github.io/STT3850/CoursePacing/CoursePacingS2025.html) for how Problem Sets will be evaluated.

:::{.callout-warning title="Tiered Feedback Explanation"}
...
:::{.callout-warning title="Assignments"}
The [Course Pacing Guide](https://alanarnholt.github.io/STT3850/CoursePacing/CoursePacingS2025.html) has all course assignments and due dates.
:::
