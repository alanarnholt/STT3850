---
title: "STT 3850 Syllabus - Fall 2023"
author: ''
date: ''
output:
  html_document:
...
**Student Help Hours:** 9:30-10:30 am M-R, and by appointment
...
You must have an active internet connection and be registered in the course to access the server. To access the server, point any web browser to <https://mathr.appstate.edu/>.  Use your Appstate Username and Password to access the server.  A screen shot of the RStudio server is shown below.
...
The [CoursePacing guide](../CoursePacing/CoursePacingF2023.html) has all course assignments and due dates.
