---
title: "STT 3850 Syllabus - Spring 2025"
format: pdf
---
...
**Student Help Hours:** 9:20am---10:40am MWF, and by appointment.
...
:::{.callout-important icon=false title="Course Texts & Materials"}
...
* 50% of the course grade will come from weekly quizzes.
...
:::{.callout-note icon=false title="University Policies"}
...
knitr::include_graphics("POSITlogin.png", dpi = 550)
```
...
:::{.callout-important icon=false title="Required Technology"}
* [RStudio Server](https://mathr.appstate.edu/)
* [DataCamp](https://www.datacamp.com/)
* [GitHub](https://github.com/)
* [Github Classroom Repository](https://github.com/STT3850-S2026)
...
:::{.callout-warning icon=false title="Assignments"}
The [Course Pacing Guide](https://alanarnholt.github.io/STT3850/CoursePacing/CoursePacingS2026.html) has all course assignments and due dates.
:::
