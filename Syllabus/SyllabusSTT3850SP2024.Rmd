---
title: "STT 3850 Syllabus - Spring 2024"
author: ''
date: ''
output:
  html_document:
...
**Student Help Hours:** 12:30-1:50 pm T-R, and by appointment
...
* Chihara, L. and Hesterberg, T. (2019). _Mathematical Statistics with Resampling and R_, Second Edition. Hoboken, NJ: John Wiley & Sons, Inc.---Available on [ASULearn](https://asulearn.appstate.edu/course/view.php?id=167073)
...
* 25% of the course grade will come from DataCamp assignments (22).  **DataCamp** assignments are assigned for students to practice coding and to receive immediate computerized feedback.  You should attempt to answer the DataCamp questions correctly and not simply ask the program to show you a solution. 60% of your DataCamp grade will be a binary grade (1 or 0) for completion of the assigned DataCamp Chapter.  The remaining 40% of your DataCamp grade will be computed at the end of the course and will be based on your total XP points accumulated in DataCamp. 

* 40% of the course grade will come from Problem Sets (9).  See the grading rubric on the [Course Pacing Guide](../CoursePacing/CoursePacingS2024.html) for how Problem Sets will be evaluated.
...
* [Github Classroom Repository](https://github.com/STT3850-Sp24)
...
The [Course Pacing Guide](../CoursePacing/CoursePacingS2024.html) has all course assignments and due dates.
