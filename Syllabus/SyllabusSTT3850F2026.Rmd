---
title: "STT 3850 Course Guide - Fall 2026"
author: ''
date: ''
output:
  html_document:
...
**Office:** Edwin Duncan Hall 123 G      
**Student Help Hours:** 10am---10:50am MTWF, and by appointment.

Make an appointment to see me by clicking [here](https://calendar.app.google/brgFqeP18zqU3Ff59).
...
* Chester Ismay and Albert Y. Kim (2020). [_Statistical Inference via Data Science: A ModernDive into R and the Tidyverse_](https://moderndive.com)

* Chihara, L. and Hesterberg, T. (2019). _Mathematical Statistics with Resampling and R_, Second Edition. Hoboken, NJ: John Wiley & Sons, Inc.---Available on [ASULearn](https://asulearn.appstate.edu/user/index.php?id=180523)
...
* 25% of the course grade will come from DataCamp assignments (25).  **DataCamp** assignments are assigned for students to practice coding and to receive immediate computerized feedback.  You should attempt to answer the DataCamp questions correctly and not simply ask the program to show you a solution. 60% of your DataCamp grade will be a binary grade (1 or 0) for completion of the assigned DataCamp Chapter.  Assignments must be completed by the due date and time.  Late work will receive a 0.  The remaining 40% of your DataCamp grade will be computed at the end of the course and will be based on your total XP points accumulated during the semester in DataCamp.  (XP greater than 22,720 A; XP greater than 21,560B; XP greater than 20,400 C; XP greater than 19,240 D) 

* 15% of the course grade will come from quizzes.

* 30% of the course grade will come from three exams.

* 30% of the course grade will come from the Final exam.
...
* [Github Classroom Repository](https://github.com/STT3850-S2025)
...
The [Course Pacing Guide](../CoursePacing/CoursePacingF2026.html) has all course assignments and due dates.
...
**_For this four-hour course, you you should anticipate 8-12 hours per week of outside work._**
