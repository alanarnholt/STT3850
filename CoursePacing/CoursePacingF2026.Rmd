---
title: "Tentative STT 3850 Course Schedule - Fall 2026"
output:
  html_document:
    css: ../css/style.css
    highlight: textmate
...
* Complete [PS-01](https://github.com/STAT-ATA-ASU/MD-PS01-SC) due by 5:00 pm Aug 21 
...
* Complete the **Data Visualization** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Aug 23

* Before class read chapter 2 (Data Visualization) of [MD](https://moderndive.com/2-viz.html) --- pgs 21-62

* Complete the **Types of Visualizations** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Aug 24

* Complete [PS-02](https://github.com/STAT-ATA-ASU/MD-PS02-SC) due by 5:00 pm Aug 27
...
* Find the file `5ng.qmd` in the `Rmarkdown` directory of the class and complete the document.
...
* Complete the **Data Wrangling** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Aug 30

* Complete the **Grouping and Summarizing** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Aug 31

* [Scales](../Quarto/scales.html)

* Complete [PS-03](https://github.com/STAT-ATA-ASU/MD-PS03-SC) by 5:00 pm Sep 3

* In-class work on [dplyr-CH1-handout](https://github.com/STAT-ATA-ASU/dplyrCH1_handout_SC)
...
* In-class work on [dplyr-CH2-handout](https://github.com/STAT-ATA-ASU/dplyrCH2_SC) 

* In-class work on [dplyr-CH3-handout](https://github.com/STAT-ATA-ASU/dplyrCH3_SC) 

* In-class work on [dplyr-CH4-handout](https://github.com/STAT-ATA-ASU/dplyrCH4_SC)  
```

___________

## Week 4: (No Class Sep 7 - Class on Sep 8---11) {-}


* [Lecture Slides](../Rmarkdown/Week04/Week4_Lect.pdf)

* Complete the **Introduction to Modeling** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Sep 7
...
* Complete the **Modeling with Basic Regression** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Sep 8

* Complete [PS-04](https://github.com/STAT-ATA-ASU/MD-PS04-SC) due by 5:00 pm Sep 10
...
* Complete the **Modeling with Multiple Regression** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments)---Due NLT 5:00 pm Sep 13
...
* Complete the **Model Assessment and Selection** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Sep 14

* Complete [PS-05](https://github.com/STAT-ATA-ASU/MD-PS05-SC) by 5:00 pm Sep 17
...
* Complete the **Summary Statistics** chapter of _Introduction to Statistics in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Sep 20
...
* Complete the **Random Numbers and Probability** chapter of _Introduction to Statistics in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Sep 21

* Complete [PS-06](https://github.com/STAT-ATA-ASU/MD-PS06-SC) by 5:00 pm Sep 24 
...
* Complete the **The binomial distribution** chapter in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Sep 27

* Complete the **Laws of probability** chapter in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Sep 28
...
* Complete the **Improving the Report** chapter of _Reporting with R Markdown_--- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments)

* Complete the **Customizing the Report** chapter of _Reporting with R Markdown_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments)
```
...
## Week 8: (Fall Break Oct 5---6;  Class Oct 8---9) {-}

* [Lecture Slides](../Rmarkdown/Week07/Week7_Lect.pdf)

* Complete the **Bayesian statistics** chapter in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Oct 7

* Complete  the **Related distributions** chapter in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Oct 8
...
* Complete  the **More Distributions and the Central Limit Theorem** chapter in _Introduction to Statistics in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Oct 11

* Before class read chapter 7 (Sampling) of [MD](https://moderndive.com/7-sampling.html) --- pgs 195-232

* Complete (will go over most questions in class) [Sampling Distributions Lab](https://classroom.github.com/a/SNc2Yj1I) by 5:00 pm Oct 12 --- not graded
[Partial Solution](https://mathr.appstate.edu/connect/content/2d388531-2e05-485b-9f58-83855a1437e3)

* Start [PS-07](https://github.com/STAT-ATA-ASU/MD-PS07-SC) due by 5:00 pm Oct 15
...
* Complete the **Bootstrapping for Estimating a Parameter** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Oct 18
...
* Complete the **Introducing the t-distribution** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Oct 19

* Complete the **Inference for Difference in Two Parameters** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Oct 20
...
* Complete [PS-08](https://github.com/STAT-ATA-ASU/MD-PS08-SC) by 5:00 pm Oct 29
...
* Complete the **Introduction to ideas of inference** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Nov 4

* Complete the **Completing a randomization test: gender discrimination** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Nov 5

* Complete the **Hypothesis testing errors: opportunity cost** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Nov 6
...
* Complete the **Inference for a Single Parameter** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Nov 8
...
* Complete the **Proportions: Testing and Power** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Nov 9

* [One Proportion](../Quarto/onep.html)

* Complete [PS-09](https://github.com/STAT-ATA-ASU/MD-PS09-SC) by 5:00 pm Nov 12
...
* Complete the **Comparing Many Parameters: Independence** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Nov 15
...
## Week 15: (Nov 23---24; Thanksgiving Break Nov 25---27; Classes Nov 30---Dec 1) {-}

* [Lecture Slides](../Rmarkdown/Week14_15/ChiSquareTests.pdf)

* [Reading material for weeks 14 and 15](../Rmarkdown/ChiSquareReading.pdf)

* Complete the **Comparing Many Parameters: Goodness of Fit** chapter in _Inference for Categorical Data in R_--- [DataCamp](https://app.datacamp.com/groups/stt3850-f2026/assignments) --- Due NLT 5:00 pm Nov 22
...
* Section -101 (11:00 am Class): Friday, Dec 4, 11 am - 1:30 pm

* Section -102 (1:00 pm Class): Saturday, Dec 5, 11 am - 1:30 pm
