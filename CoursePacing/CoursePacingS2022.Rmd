---
title: "Tentative STT 3850 Course Schedule - Spring 2022"
output:
  html_document:
    css: ../css/style.css
    highlight: textmate
...
* Complete [PS-01](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) due by 5:00 pm Jan 13 --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) --- [VIDEO of how to accept and clone the assignment](https://drive.google.com/file/d/1MfDjhNb5m_45BCVD6ZQCXhgIMWwwx0oS/view?usp=sharing)
...
## Week 2: No Class Jan 17 (Jan 18--20) {-}
...
* Complete the **Data Visualization** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Jan 19

* Complete the **Types of Visualizations** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Jan 19

* Complete [PS-02](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) due by 5:00 pm Jan 20 --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 
...
* Complete the **Data Wrangling** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Jan 25

* Complete the **Grouping and Summarizing** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Jan 26

* Complete [PS-03](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) by 5:00 pm Jan 27 --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 

* Inclass work on [dplyr-CH1-handout](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) (link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 
...
* Inclass work on [dplyr-CH2-handout](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) (link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 

* Inclass work on [dplyr-CH3-handout](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) (link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 

* Inclass work on [dplyr-CH4-handout](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) (link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 
```
...
* Complete the **Introduction to Modeling** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Feb 1

* Complete the **Modeling with Basic Regression** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Feb 2

* Complete [PS-04](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) due by 5:00 pm Feb 3  --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 


```{block, week4optional, type='rmdoptional'}
#### Optional {-}

* Read chapter 4 (Data Importing and "Tidy" Data) of [MD](https://moderndive.com) --- pgs 99-117
...
* Complete the **Modeling with Multiple Regression** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Feb 8

* Complete the **Model Assessment and Selection** chapter of _Modeling with Data in the TIdyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Feb 9

* Complete [PS-05](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) by 5:00 pm Feb 10 --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 
...
* Before class read/review chapter 6 (Multiple Regression) of [MD](https://moderndive.com) --- pgs 161-191

* Go over in class [_Misc Regression_](../Rmarkdown/MiscRegression.html)

* Complete [PS-06](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) by 5:00 pm Feb 17 --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 
...
* Complete (**The binomial distribution**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Feb 22

* Complete (**Laws of probability**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Feb 23

* Complete (**Bayesian statistics**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Feb 24
...
* Complete the **Improving the Report** chapter of _Reporting with R Markdown_--- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments)

* Complete the **Customizing the Report** chapter of _Reporting with R Markdown_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments)
```
...
* Complete (**Related distributions**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Feb 28
...
* Compete (will go over most questions in class) [Sampling Distributions Lab](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) by 5:00 pm Mar 16 --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 

* Complete [PS-07](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) by 5:00 pm Mar 17 --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 
...
* Before class read chapter 8 (Bootstrapping and Confidence Intervals) of [MD](https://moderndive.com) --- pgs 233-305

* Read Chapter 5 of MSWR

* [Chapter 5 notes](../Notes/Children/BootStrap2.html)

* Complete the **Bootstrapping for Estimating a Parameter** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Mar 22

* Complete the **Introducing the t-distribution** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Mar 23

* Complete the **Inference for Difference in Two Parameters** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Mar 24
...
* Before class review chapter 8 (Bootstrapping and Confidence Intervals) of [MD](https://moderndive.com) --- pgs 233-305

* [Chapter 7 notes](../Notes/Children/ConfidenceIntervals2.html)

* [Bootstrap $t$](../Rmarkdown/MoreBootstrapping.html)

* Complete [PS-08](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) by 5:00 pm Mar 31 --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 
...
* Complete the **Introduction to ideas of inference** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Apr 5

* Complete the **Completing a randomization test: gender discrimination** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Apr 6

* Complete the **Hypothesis testing errors: opportunity cost** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Apr 7
...
* Before class review Chapter 9 (Hypothesis Testing) of [MD](https://moderndive.com) --- pgs 307-360

* Complete the **Inference for a Single Parameter** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Apr 12

* Complete the **Proportions: Testing and Power** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Apr 13

* Complete [PS-09](https://classroom.github.com/classrooms/87543903-stt3850-fall2021) by 5:00 pm Apr 14 --- (assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885)) 
...
* Complete the **Comparing Many Parameters: Independence** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Apr 19

* Complete the **Comparing Many Parameters: Goodness of Fit** chapter in _Inference for Categorical Data in R_--- [DataCamp](https://app.datacamp.com/groups/stt3850-fall2021/assignments) --- Due NLT 5:00 pm Apr 20
...
* Work on Reproduction of _Inference for Numerical Data in R_ --- assignment link in [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=136885) - Due NLT 5:00 PM Apr 29, 2021

__________________________________

## Final Exam --- April 29: 11:00am - 1:30 pm
