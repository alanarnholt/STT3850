...
* Complete [PS-01](https://classroom.github.com/a/f6GF22sm) due by 5:00 pm Jan 13 --- [VIDEO of how to accept and clone the assignment](https://drive.google.com/file/d/1MfDjhNb5m_45BCVD6ZQCXhgIMWwwx0oS/view?usp=sharing)
...
* Complete the **Data Visualization** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Jan 19

* Complete the **Types of Visualizations** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Jan 19

* Complete [PS-02](https://classroom.github.com/a/91sZf3ud) due by 5:00 pm Jan 20 
...
* Complete the **Data Wrangling** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Jan 25

* Complete the **Grouping and Summarizing** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Jan 26

* Complete [PS-03](https://classroom.github.com/a/WqeE__Vu) by 5:00 pm Jan 27

* Inclass work on [dplyr-CH1-handout](https://classroom.github.com/a/0eb-Mbaw)
...
* Inclass work on [dplyr-CH2-handout](https://classroom.github.com/a/zv7M_OfZ) 

* Inclass work on [dplyr-CH3-handout](https://classroom.github.com/a/2KlJGRGA) 

* Inclass work on [dplyr-CH4-handout](https://classroom.github.com/a/n3MO3v-H) 
```
...
* Complete the **Introduction to Modeling** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Feb 1

* Complete the **Modeling with Basic Regression** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Feb 2

* Complete [PS-04](https://classroom.github.com/a/-ge5pR2G) due by 5:00 pm Feb 3 
...
* Complete the **Modeling with Multiple Regression** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Feb 8

* Complete the **Model Assessment and Selection** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Feb 9

* Complete [PS-05](https://classroom.github.com/a/qm87hAwU) by 5:00 pm Feb 10 
...
* Complete [PS-06](https://classroom.github.com/a/bn4_j8ur) by 5:00 pm Feb 17 
...
* Complete (**The binomial distribution**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Feb 22

* Complete (**Laws of probability**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Feb 23

* Complete (**Bayesian statistics**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Feb 24
...
* Complete the **Improving the Report** chapter of _Reporting with R Markdown_--- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments)

* Complete the **Customizing the Report** chapter of _Reporting with R Markdown_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments)
```
...
* Complete (**Related distributions**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Feb 28
...
* Compete (will go over most questions in class) [Sampling Distributions Lab](https://classroom.github.com/a/009Ftxeg) by 5:00 pm Mar 16 

* Complete [PS-07](https://classroom.github.com/a/ZCby6Vmp) by 5:00 pm Mar 17
...
* Complete the **Bootstrapping for Estimating a Parameter** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Mar 22

* Complete the **Introducing the t-distribution** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Mar 23

* Complete the **Inference for Difference in Two Parameters** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Mar 24
...
* Complete [PS-08](https://classroom.github.com/a/LfGTZ1pd) by 5:00 pm Mar 31 
...
* Complete the **Introduction to ideas of inference** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Apr 5

* Complete the **Completing a randomization test: gender discrimination** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Apr 6

* Complete the **Hypothesis testing errors: opportunity cost** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Apr 7
...
* Complete the **Inference for a Single Parameter** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Apr 12

* Complete the **Proportions: Testing and Power** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Apr 13

* Complete [PS-09](https://classroom.github.com/a/rfO_Zrh8) by 5:00 pm Apr 14 
...
* Complete the **Comparing Many Parameters: Independence** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Apr 19

* Complete the **Comparing Many Parameters: Goodness of Fit** chapter in _Inference for Categorical Data in R_--- [DataCamp](https://app.datacamp.com/groups/stt3850-sp22/assignments) --- Due NLT 5:00 pm Apr 20
...
* Work on Reproduction of [_Inference for Numerical Data in R_](https://classroom.github.com/a/7zg6hIB8) - Due NLT 5:00 PM Apr 29
