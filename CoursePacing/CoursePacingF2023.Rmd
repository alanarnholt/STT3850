---
title: "Tentative STT 3850 Course Schedule - Fall 2023"
output:
  html_document:
    css: ../css/style.css
    highlight: textmate
...
2.  The principal documents for this course are [_ModernDive: An Introduction to Statistical and Data Sciences via R_](https://moderndive.com) (MD), [_Data Science with R_](https://stat-ata-asu.github.io/R_DS_BD2020/) (DSWR), and _Mathematical Statistics with Resampling and R_ (MSWR) -available inside the [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=159655) course page.
3.  Problem Set (PS) assignments are generally due on Thursdays by 5:00 pm
4.  The links for the problem sets and the sampling distribution assignment in this document will only work for the instructor!  To accept each of these assignments, go to [ASULEARN](https://asulearn.appstate.edu/course/view.php?id=159655) and click on the appropriate link in the [GitHub Classroom Invitation Links for Assignments](https://asulearn.appstate.edu/course/view.php?id=159655) block.  
```
...
* Complete [PS-01](https://classroom.github.com/a/cDQEnd1b) due by 5:00 pm Aug 24 
...
* Complete the **Data Visualization** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Aug 29

* Complete the **Types of Visualizations** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Aug 30

* Complete [PS-02](https://classroom.github.com/a/ya63seki) due by 5:00 pm Aug 31
...
* Complete the **Data Wrangling** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Sep 5

* Complete the **Grouping and Summarizing** chapter of _Introduction to the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Sep 6

* Complete [PS-03](https://classroom.github.com/a/Zvfqni-u) by 5:00 pm Sep 7

* In-class work on [dplyr-CH1-handout](https://classroom.github.com/a/NyM5bW7s)
...
* In-class work on [dplyr-CH2-handout](https://classroom.github.com/a/2niw0EM8) 
* In-class work on [dplyr-CH3-handout](https://classroom.github.com/a/YkUNrp9c) 
* In-class work on [dplyr-CH4-handout](https://classroom.github.com/a/TN2kYM42) 
```
...
* Complete the **Introduction to Modeling** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Sep 12

* Complete the **Modeling with Basic Regression** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Sep 13

* Complete [PS-04](https://classroom.github.com/a/uuTnPphb) due by 5:00 pm Sep 14
...
* Complete the **Modeling with Multiple Regression** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Sep 19

* Complete the **Model Assessment and Selection** chapter of _Modeling with Data in the Tidyverse_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Sep 20

* Complete [PS-05](https://classroom.github.com/a/4MMydu5I) by 5:00 pm Sep 21 
...
* Complete [PS-06](https://classroom.github.com/a/Nusd7CFc) by 5:00 pm Sep 28 
...
* Complete (**The binomial distribution**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Oct 3

* Complete (**Laws of probability**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Oct 4

* Complete (**Bayesian statistics**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Oct 5
...
* Complete the **Improving the Report** chapter of _Reporting with R Markdown_--- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments)

* Complete the **Customizing the Report** chapter of _Reporting with R Markdown_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments)
```
...
* Complete (**Related distributions**) in _Foundations of Probability in R_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Oct 10

* **Mid-Term Exam/Opportunity To Excel** --- Due no later than 2:00 pm Oct 12 
...
* Complete (will go over most questions in class) [Sampling Distributions Lab](https://classroom.github.com/a/eZq-1bTl) by 5:00 pm Oct 18 --- not graded
[Partial Solution](https://mathr.appstate.edu/connect/content/2d388531-2e05-485b-9f58-83855a1437e3)

* Start [PS-07](https://classroom.github.com/a/Zl9Dwml1) due by 5:00 pm Oct 26
...
* Complete the **Bootstrapping for Estimating a Parameter** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Oct 24

* Complete the **Introducing the t-distribution** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Oct 25

* Complete the **Inference for Difference in Two Parameters** chapter in _Inference for Numerical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Oct 26

* Bootstrap [Example](https://stat-ata-asu.github.io/STT3851ClassRepo/Rmarkdown/TheBootstrap.html)

* Complete [PS-07](https://classroom.github.com/a/Zl9Dwml1) by 5:00 pm Oct 26
...
* Complete [PS-08](https://classroom.github.com/a/Z7hhTyVF) by 5:00 pm ~~Nov 2~~ Nov 9 

* [Slides for weeks 11, 12, and 13](../Slides/Weeks11_12_13.pdf)
...
* Complete the **Introduction to ideas of inference** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Nov 7

* Complete the **Completing a randomization test: gender discrimination** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Nov 8

* Complete the **Hypothesis testing errors: opportunity cost** chapter of _Foundations of Inference_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Nov 9

* Complete [PS-08](https://classroom.github.com/a/Z7hhTyVF) by 5:00 pm Nov 9 
...
* Complete the **Inference for a Single Parameter** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Nov 14

* Complete the **Proportions: Testing and Power** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Nov 15

* Complete [PS-09](https://classroom.github.com/a/OkAkSN2h) by 5:00 pm ~~Nov 16~~ Nov 22 
...
* Complete the **Comparing Many Parameters: Independence** chapter in _Inference for Categorical Data in R_ --- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Nov 21

* Complete [PS-09](https://classroom.github.com/a/OkAkSN2h) by 5:00 pm Nov 22 
...
* Complete the **Comparing Many Parameters: Goodness of Fit** chapter in _Inference for Categorical Data in R_--- [DataCamp](https://app.datacamp.com/groups/stt-3850-fall23/assignments) --- Due NLT 5:00 pm Nov 28
...
## Final Exam --- Section -103 (9:30 am Class): Dec 12: 8:00am - 10:30 am
## Final Exam --- Section -104 (11:00 am Class): Dec 7: 11:00am - 1:30 pm
