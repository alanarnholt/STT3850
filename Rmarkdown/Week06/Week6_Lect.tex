...
\phantomsection\label{extra-sums-of-squares-1}
...
\phantomsection\label{term-life-insurance-example}
...
\phantomsection\label{term-life-insurance-example-1}
\normalsize
...
\phantomsection\label{extra-sums-of-squares-y-on-x_1}
\footnotesize
...
\begin{frame}[fragile]{Extra Sums of Squares: \(y\) on \(x_1\)}
\phantomsection\label{extra-sums-of-squares-y-on-x_1-1}
\normalsize
...
\phantomsection\label{extra-sums-of-squares-y-on-x_2}
\footnotesize
...
\begin{frame}[fragile]{Extra Sums of Squares: \(y\) on \(x_2\)}
\phantomsection\label{extra-sums-of-squares-y-on-x_2-1}
\normalsize
...
\(x_2\)}
\phantomsection\label{extra-sums-of-squares-y-on-x_1-and-x_2}
\footnotesize
...
\begin{frame}[fragile]{Extra Sums of Squares: \(y\) on \(x_1\) and
\(x_2\)}
\phantomsection\label{extra-sums-of-squares-y-on-x_1-and-x_2-1}
\normalsize
...
and \(x_3\)}
\phantomsection\label{extra-sums-of-squares-y-on-x_1-x_2-and-x_3}
\scriptsize
...
\begin{frame}[fragile]{Extra Sums of Squares: \(y\) on \(x_1\), \(x_2\)
and \(x_3\)}
\phantomsection\label{extra-sums-of-squares-y-on-x_1-x_2-and-x_3-1}
\normalsize
...
\begin{frame}{Extra Sums of Squares}
\phantomsection\label{extra-sums-of-squares-2}
\begin{table}[h]
\centering
...
\begin{frame}{Extra Sums of Squares}
\phantomsection\label{extra-sums-of-squares-3}
\begin{table}[h]
\centering
\resizebox{0.7\textheight}{!}{
    \medskip{}\begin{tabular}{lll}
...
\phantomsection\label{analysis-of-variance-anova}
...
\phantomsection\label{analysis-of-variance-anova-1}
\normalsize
...
\phantomsection\label{tests-for-regression-coefficients}
...
\begin{frame}{Tests for Regression Coefficients}
\phantomsection\label{tests-for-regression-coefficients-1}
...
\begin{frame}{Tests for Regression Coefficients}
\phantomsection\label{tests-for-regression-coefficients-2}
...
\begin{frame}[fragile]{Term Life Insurance Example}
\phantomsection\label{term-life-insurance-example-2}
...
\begin{frame}[fragile]{Term Life Insurance Example}
\phantomsection\label{term-life-insurance-example-3}
...
\phantomsection\label{testing-more-than-one-coefficient}
Consider testing:
...
\begin{frame}[fragile]{Testing More Than One Coefficient}
\phantomsection\label{testing-more-than-one-coefficient-1}
\normalsize
...
Predictors}
\phantomsection\label{is-there-a-relationship-between-the-response-and-predictors}
Now, we test:
...
Predictors}
\phantomsection\label{is-there-a-relationship-between-the-response-and-predictors-1}
\normalsize
...
\begin{frame}[fragile]{Is There a Relationship Between the Response and
Predictors}
\phantomsection\label{is-there-a-relationship-between-the-response-and-predictors-2}
\normalsize
...
\begin{frame}[fragile]{Is There a Relationship Between the Response and
Predictors}
\phantomsection\label{is-there-a-relationship-between-the-response-and-predictors-3}
\scriptsize
...
\phantomsection\label{model-selection-1}
...
\phantomsection\label{r2-and-adjusted-r2-r2_textadj}
...
\begin{frame}{\(R^2\) and Adjusted \(R^2\) (\(R^2_{\text{adj}}\))}
\phantomsection\label{r2-and-adjusted-r2-r2_textadj-1}
...
\begin{frame}{\(R^2\) and Adjusted \(R^2\) (\(R^2_{\text{adj}}\))}
\phantomsection\label{r2-and-adjusted-r2-r2_textadj-2}
...
\phantomsection\label{compare-interaction-and-parallel-slopes-model}
\scriptsize
...
\begin{frame}[fragile]{Compare Interaction and Parallel slopes model}
\phantomsection\label{compare-interaction-and-parallel-slopes-model-1}
\scriptsize
...
\begin{frame}[fragile]{Compare Interaction and Parallel slopes model}
\phantomsection\label{compare-interaction-and-parallel-slopes-model-2}
\footnotesize
...
\phantomsection\label{aic-akaike-information-criterion}
...
\phantomsection\label{bic-bayes-information-criterion}
...
\begin{frame}[fragile]{Compare Interaction and Parallel slopes model}
\phantomsection\label{compare-interaction-and-parallel-slopes-model-3}
\normalsize
...
\phantomsection\label{best-subset-algorithm}
...
\phantomsection\label{stepwise-procedures}
...
\begin{frame}[fragile]{Stepwise Procedures}
\phantomsection\label{stepwise-procedures-1}
...
\begin{frame}{Term Life Insurance Example}
\phantomsection\label{term-life-insurance-example-4}
Like all firms, life insurance companies continually seek new ways to
deliver products to the market. Those involved in product development
want to know who buys insurance and how much they buy. In this example,
we examine the Survey of Consumer Finances (SCF), that contains
...
\begin{frame}[fragile]{Term Life Insurance Example}
\phantomsection\label{term-life-insurance-example-5}
\tiny
...
\begin{frame}[fragile]{Term Life Insurance Example}
\phantomsection\label{term-life-insurance-example-6}
\scriptsize
...
\phantomsection\label{multicollinearity-and-its-effects}
\begin{itemize}
\item
...
\begin{frame}{Variance Inflation Factor}
\phantomsection\label{variance-inflation-factor-1}
...
\phantomsection\label{high-blood-pressure-example}
\begin{itemize}
\item
...
\phantomsection\label{high-blood-pressure-example-1}
...
\begin{frame}[fragile]{High Blood Pressure Example}
\phantomsection\label{high-blood-pressure-example-2}
\scriptsize
...
\begin{frame}[fragile]{High Blood Pressure Example}
\phantomsection\label{high-blood-pressure-example-3}
\normalsize
...
\phantomsection\label{variance-inflation-factor-2}
\scriptsize
...
\begin{frame}[fragile]{Variance Inflation Factor}
\phantomsection\label{variance-inflation-factor-3}
\tiny
...
\begin{frame}[fragile]{Variance Inflation Factor}
\phantomsection\label{variance-inflation-factor-4}
\tiny
