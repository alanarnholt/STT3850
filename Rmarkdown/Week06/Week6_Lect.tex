...
\NormalTok{SST }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{((Term2}\SpecialCharTok{$}\NormalTok{LNFACE }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(Term2}\SpecialCharTok{$}\NormalTok{LNFACE))}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
