...
This problem roughly follows 5.14 from page 145 of your text (@hesterberg_mathematical_2018).  One important difference is that we are performing a two-sided test (not a directional test) as the book requests.
