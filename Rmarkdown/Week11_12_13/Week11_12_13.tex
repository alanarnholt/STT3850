...
\phantomsection\label{by-the-end-of-week-13}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{confidence-intervals-for-a-difference-in-means}
...
\begin{frame}{Confidence Intervals for a Difference in Means}
\phantomsection\label{confidence-intervals-for-a-difference-in-means-1}
...
\phantomsection\label{example-1-1}
\small
...
\begin{frame}[fragile]{Example 1}
\phantomsection\label{example-1-2}
\small
...
\begin{frame}[fragile]{Example 1}
\phantomsection\label{example-1-3}
\tiny
...
\begin{frame}[fragile]{Example 1}
\phantomsection\label{example-1-4}
...
\begin{frame}{Confidence Intervals for a Difference in Means}
\phantomsection\label{confidence-intervals-for-a-difference-in-means-2}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Example 2}
\phantomsection\label{example-2-2}
\tiny
...
\begin{frame}[fragile]{Example 2}
\phantomsection\label{example-2-3}
\tiny
...
\phantomsection\label{confidence-intervals-for-proportions}
\begin{tcolorbox}
...
\begin{frame}{Confidence Intervals for Proportions}
\phantomsection\label{confidence-intervals-for-proportions-1}
Thus:
...
\phantomsection\label{the-wald-method}
...
\begin{frame}{The Wald method}
\phantomsection\label{the-wald-method-1}
\begin{tcolorbox}
...
\phantomsection\label{the-wald-method-2}
\small
...
\phantomsection\label{the-agresti-coull-interval-for-a-proportion}
...
\begin{frame}{The Agresti-Coull Interval for a Proportion}
\phantomsection\label{the-agresti-coull-interval-for-a-proportion-1}
\begin{tcolorbox}
In 2010, according to an AP-Gfk Poll conducted on October 13-18, $59\%$ of 846 likely voters responded that they felt things in this country were heading in the wrong direction (http:www.ap-gfkpoll.com/poll.archive.html). Find a $95\%$ confidence interval. 
\end{tcolorbox}
...
\phantomsection\label{the-agresti-coull-interval-for-a-proportion-2}
\small
...
\phantomsection\label{wilson-score-method}
...
\begin{frame}{Wilson Score method}
\phantomsection\label{wilson-score-method-1}
\begin{tcolorbox}
In 2010, according to an AP-Gfk Poll conducted on October 13-18, $59\%$ of 846 likely voters responded that they felt things in this country were heading in the wrong direction (http:www.ap-gfkpoll.com/poll.archive.html). Find a $95\%$ confidence interval. 
\end{tcolorbox}
...
\phantomsection\label{wilson-score-method-2}
\tiny
...
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals}
\begin{itemize}
\item
...
\begin{frame}{Coverage Probabilities of Binomial Confidence Intervals}
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals-1}
...
\begin{frame}{Coverage Probabilities of Binomial Confidence Intervals}
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals-2}
\begin{itemize}
\item
...
Intervals}
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals-3}
\tiny
...
\begin{frame}[fragile]{Coverage Probabilities of Binomial Confidence
Intervals}
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals-4}
Now use \(p=0.79\) \tiny
...
\begin{frame}[fragile]{Coverage Probabilities of Binomial Confidence
Intervals - Wald}
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals---wald}
...
\begin{frame}{Coverage Probabilities of Binomial Confidence Intervals -
Wald}
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals---wald-1}
\tiny
...
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals---agresti-coull}
...
\begin{frame}{Coverage Probabilities of Binomial Confidence Intervals -
Agresti-Coull}
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals---agresti-coull-1}
\tiny
...
\begin{frame}[fragile]{Coverage Probabilities of Binomial Confidence
Intervals - Wilson}
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals---wilson}
...
\begin{frame}{Coverage Probabilities of Binomial Confidence Intervals -
Wilson}
\phantomsection\label{coverage-probabilities-of-binomial-confidence-intervals---wilson-1}
\tiny
...
\phantomsection\label{bootstrap-t-confidence-interval-1}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Bootstrap \(t\) Confidence Interval}
\phantomsection\label{bootstrap-t-confidence-interval-2}
\tiny
...
\phantomsection\label{bootstrap-t-confidence-interval-3}
Instead
...
\begin{frame}[fragile]{Bootstrap \(t\) Confidence Interval}
\phantomsection\label{bootstrap-t-confidence-interval-4}
\tiny
...
\begin{frame}[fragile]{Bootstrap \(t\) Confidence Interval}
\phantomsection\label{bootstrap-t-confidence-interval-5}
\tiny
...
\begin{frame}{Bootstrap \(t\) Confidence Interval}
\phantomsection\label{bootstrap-t-confidence-interval-6}
\tiny
...
\begin{frame}{Bootstrap \(t\) Confidence Interval}
\phantomsection\label{bootstrap-t-confidence-interval-7}
\begin{itemize}
\item
...
\begin{frame}{Bootstrap \(t\) Confidence Interval}
\phantomsection\label{bootstrap-t-confidence-interval-8}
\begin{itemize}
\item
...
\begin{frame}{Bootstrap \(t\) Confidence Interval}
\phantomsection\label{bootstrap-t-confidence-interval-9}
\begin{itemize}
\item
  Let
...
\begin{frame}[fragile]{Bootstrap \(t\) Confidence Interval}
\phantomsection\label{bootstrap-t-confidence-interval-10}
\begin{itemize}
\item
...
\phantomsection\label{using-the-package-boot}
...
\begin{frame}[fragile]{Using the package \texttt{boot}}
\phantomsection\label{using-the-package-boot-1}
\tiny
...
\begin{frame}[fragile]{Using the package \texttt{boot}}
\phantomsection\label{using-the-package-boot-2}
\tiny
...
\begin{frame}[fragile]{Using the package \texttt{boot}}
\phantomsection\label{using-the-package-boot-3}
\tiny
...
\(\mu_1-\mu_2\)}
\phantomsection\label{bootstrap-t-confidence-interval-for-mu_1-mu_2}
...
means}
\phantomsection\label{using-the-package-boot-for-the-difference-in-means}
...
\begin{frame}[fragile]{Using the package boot for the difference in
means}
\phantomsection\label{using-the-package-boot-for-the-difference-in-means-1}
\tiny
...
\begin{frame}[fragile]{Using the package boot for the difference in
means}
\phantomsection\label{using-the-package-boot-for-the-difference-in-means-2}
\tiny
...
Intervals}
\phantomsection\label{comparing-bootstrap-t-and-formula-t-confidence-intervals}
\begin{itemize}
\item
...
\phantomsection\label{fundamental-question-of-inference}
...
\begin{frame}[fragile]{Needed packages}
\phantomsection\label{needed-packages-1}
...
\phantomsection\label{promotions-activity}
...
\begin{frame}{Promotions activity}
\phantomsection\label{promotions-activity-1}
...
\phantomsection\label{promotions-activity-2}
...
\begin{frame}[fragile]{Promotions activity}
\phantomsection\label{promotions-activity-3}
...
\begin{frame}[fragile]{Promotions activity}
\phantomsection\label{promotions-activity-4}
...
\begin{frame}{Promotions activity}
\phantomsection\label{promotions-activity-5}
...
\phantomsection\label{promotions-activity-shuffling-once}
...
\begin{frame}[fragile]{Promotions activity: Shuffling once}
\phantomsection\label{promotions-activity-shuffling-once-1}
\begin{itemize}
\item
...
\phantomsection\label{promotions-activity-shuffling-once-2}
\begin{itemize}
\item
...
\begin{frame}{Promotions activity: Shuffling once}
\phantomsection\label{promotions-activity-shuffling-once-3}
\begin{itemize}
\tightlist
\item
...
\begin{frame}[fragile]{Promotions activity: Shuffling once}
\phantomsection\label{promotions-activity-shuffling-once-4}
...
\begin{frame}[fragile]{Promotions activity: Shuffling once}
\phantomsection\label{promotions-activity-shuffling-once-5}
...
\phantomsection\label{promotions-activity-shuffling-16-times}
\begin{itemize}
\item
...
\begin{frame}{Promotions activity: Shuffling 16 times}
\phantomsection\label{promotions-activity-shuffling-16-times-1}
Things to note:
...
\begin{frame}{Fundamental Question of Inference}
\phantomsection\label{fundamental-question-of-inference-1}
\begin{itemize}
\item
  Ask yourself:
...
\phantomsection\label{what-did-we-just-do}
...
\phantomsection\label{what-did-we-just-do-1}
...
\phantomsection\label{understanding-hypothesis-tests-1}
...
\begin{frame}{Understanding hypothesis tests}
\phantomsection\label{understanding-hypothesis-tests-2}
...
\begin{frame}{Understanding hypothesis tests}
\phantomsection\label{understanding-hypothesis-tests-3}
...
\begin{frame}{Understanding hypothesis tests}
\phantomsection\label{understanding-hypothesis-tests-4}
...
\begin{frame}{Understanding hypothesis tests}
\phantomsection\label{understanding-hypothesis-tests-5}
\begin{itemize}
\item
...
\begin{frame}{Understanding hypothesis tests}
\phantomsection\label{understanding-hypothesis-tests-6}
...
\begin{frame}{Understanding hypothesis tests}
\phantomsection\label{understanding-hypothesis-tests-7}
...
\begin{frame}{Understanding hypothesis tests}
\phantomsection\label{understanding-hypothesis-tests-8}
\begin{itemize}
\item
...
\begin{frame}{Understanding hypothesis tests}
\phantomsection\label{understanding-hypothesis-tests-9}
...
\section{Conducting hypothesis tests}\label{conducting-hypothesis-tests}

\begin{frame}[fragile]{Conducting hypothesis tests}
\phantomsection\label{conducting-hypothesis-tests-1}
...
variables}
\phantomsection\label{infer-package-workflow-specify-variables}
...
\phantomsection\label{infer-package-workflow-hypothesize-the-null}
...
null}
\phantomsection\label{infer-package-workflow-hypothesize-the-null-1}
\begin{itemize}
\item
...
\begin{frame}[fragile]{\texttt{infer} package workflow:
\texttt{hypothesize} the null}
\phantomsection\label{infer-package-workflow-hypothesize-the-null-2}
\begin{itemize}
\item
...
\begin{frame}[fragile]{\texttt{infer} package workflow:
\texttt{hypothesize} the null}
\phantomsection\label{infer-package-workflow-hypothesize-the-null-3}
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{promotions }\SpecialCharTok{|\textgreater{}} 
...
\phantomsection\label{infer-package-workflow-generate-replicates}
\begin{itemize}
\item
...
\begin{frame}[fragile]{\texttt{infer} package workflow:
\texttt{generate} replicates}
\phantomsection\label{infer-package-workflow-generate-replicates-1}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{infer-package-workflow-calculate-summary-statistics}
...
\begin{frame}[fragile]{\texttt{infer} package workflow:
\texttt{calculate} summary statistics}
\phantomsection\label{infer-package-workflow-calculate-summary-statistics-1}
\tiny
...
\begin{frame}[fragile]{\texttt{infer} package workflow:
\texttt{calculate} summary statistics}
\phantomsection\label{infer-package-workflow-calculate-summary-statistics-2}
...
\phantomsection\label{infer-package-workflow-visualize-the-p-value}
...
\begin{frame}[fragile]{\texttt{infer} package workflow:
\texttt{visualize} the p-value}
\phantomsection\label{infer-package-workflow-visualize-the-p-value-1}
\begin{itemize}
\item
...
p-value}
\phantomsection\label{infer-package-workflow-visualize-the-p-value-2}
...
\phantomsection\label{comparison-with-confidence-intervals}
...
\begin{frame}[fragile]{Comparison with confidence intervals}
\phantomsection\label{comparison-with-confidence-intervals-1}
...
\begin{frame}[fragile]{Comparison with confidence intervals}
\phantomsection\label{comparison-with-confidence-intervals-2}
\tiny
...
\phantomsection\label{interpreting-hypothesis-tests-1}
\begin{itemize}
\item
...
\begin{frame}{Interpreting hypothesis tests}
\phantomsection\label{interpreting-hypothesis-tests-2}
...
\phantomsection\label{types-of-errors}
\begin{itemize}
\item
...
\begin{frame}{Types of errors}
\phantomsection\label{types-of-errors-1}
...
\phantomsection\label{probabilities-of-type-i-and-ii-errors}
\begin{itemize}
\item
...
\phantomsection\label{relationship-between-sample-size-errors-and-power}
\begin{columns}
...
\phantomsection\label{relationship-between-errors-and-power}
\begin{itemize}
\item
