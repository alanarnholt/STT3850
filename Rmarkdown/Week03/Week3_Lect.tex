...
\phantomsection\label{data-wrangling-1}
...
\begin{frame}[fragile]{Data Wrangling}
\phantomsection\label{data-wrangling-2}
\begin{enumerate}
\setcounter{enumi}{3}
\item
...
\phantomsection\label{the-pipe-operator}
...
\begin{frame}[fragile]{The pipe operator:
\texttt{\textbar{}\textgreater{}}}
\phantomsection\label{the-pipe-operator-1}
...
\phantomsection\label{filter-rows}
...
\begin{frame}[fragile]{\texttt{filter} rows}
\phantomsection\label{filter-rows-1}
\begin{itemize}
\item
...
\begin{frame}[fragile]{\texttt{filter} rows}
\phantomsection\label{filter-rows-2}
\begin{itemize}
\item
...
\begin{frame}[fragile]{\texttt{filter} rows}
\phantomsection\label{filter-rows-3}
\begin{itemize}
\item
...
\begin{frame}[fragile]{\texttt{filter} rows}
\phantomsection\label{filter-rows-4}
...
\begin{frame}[fragile]{\texttt{filter} rows}
\phantomsection\label{filter-rows-5}
...
\phantomsection\label{summarize-variables}
...
\phantomsection\label{summarize-variables-1}
...
\begin{frame}[fragile]{\texttt{summarize} variables}
\phantomsection\label{summarize-variables-2}
\begin{itemize}
\item
...
\begin{frame}[fragile]{\texttt{summarize} variables}
\phantomsection\label{summarize-variables-3}
...
\begin{frame}[fragile]{\texttt{group\_by}}
\phantomsection\label{group_by-1}
\normalsize
...
\phantomsection\label{grouping-by-more-than-one-variable}
...
\begin{frame}[fragile]{Grouping by more than one variable}
\phantomsection\label{grouping-by-more-than-one-variable-1}
...
\phantomsection\label{mutate-existing-variables}
...
\phantomsection\label{mutate-existing-variables-1}
...
\begin{frame}[fragile]{\texttt{mutate} existing variables}
\phantomsection\label{mutate-existing-variables-2}
\begin{itemize}
\item
  In this code:
...
\begin{frame}[fragile]{\texttt{mutate} existing variables}
\phantomsection\label{mutate-existing-variables-3}
...
\begin{frame}[fragile]{\texttt{mutate} existing variables}
\phantomsection\label{mutate-existing-variables-4}
...
\begin{frame}[fragile]{\texttt{mutate} existing variables}
\phantomsection\label{mutate-existing-variables-5}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{frame}[fragile]{\texttt{mutate} existing variables}
\phantomsection\label{mutate-existing-variables-6}
...
\begin{frame}[fragile]{\texttt{mutate} existing variables}
\phantomsection\label{mutate-existing-variables-7}
...
\phantomsection\label{arrange-and-sort-rows}
\begin{itemize}
\item
...
\begin{frame}[fragile]{\texttt{arrange} and sort rows}
\phantomsection\label{arrange-and-sort-rows-1}
...
\begin{frame}[fragile]{\texttt{arrange} and sort rows}
\phantomsection\label{arrange-and-sort-rows-2}
...
\begin{frame}[fragile]{\texttt{arrange} and sort rows}
\phantomsection\label{arrange-and-sort-rows-3}
...
\phantomsection\label{join-data-frames}
...
\begin{frame}[fragile]{\texttt{join} data frames}
\phantomsection\label{join-data-frames-1}
...
\phantomsection\label{matching-key-variable-names}
...
\begin{frame}[fragile]{Matching ``key'' variable names}
\phantomsection\label{matching-key-variable-names-1}
...
\phantomsection\label{different-key-variable-names}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Different ``key'' variable names}
\phantomsection\label{different-key-variable-names-1}
...
\begin{frame}[fragile]{Different ``key'' variable names}
\phantomsection\label{different-key-variable-names-2}
...
\phantomsection\label{multiple-key-variables}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Multiple ``key'' variables}
\phantomsection\label{multiple-key-variables-1}
\normalsize
...
\phantomsection\label{select-variables}
...
\begin{frame}[fragile]{\texttt{select} variables}
\phantomsection\label{select-variables-1}
...
\begin{frame}[fragile]{\texttt{select} variables}
\phantomsection\label{select-variables-2}
...
\begin{frame}[fragile]{\texttt{select} variables}
\phantomsection\label{select-variables-3}
...
\begin{frame}[fragile]{\texttt{select} variables}
\phantomsection\label{select-variables-4}
...
\phantomsection\label{tidy-data-1}
...
\begin{frame}[fragile]{``Tidy'' data}
\phantomsection\label{tidy-data-2}
...
\phantomsection\label{tidy-data-3}
\begin{itemize}
\item
...
\phantomsection\label{tidy-data-definition}
...
\begin{frame}{``Tidy'' data: Definition}
\phantomsection\label{tidy-data-definition-1}
...
\begin{frame}{``Tidy'' data: Definition}
\phantomsection\label{tidy-data-definition-2}
\begin{itemize}
\item
  Observe that:
...
\phantomsection\label{coverting-to-tidy-format}
...
\begin{frame}[fragile]{Coverting to ``Tidy'' format}
\phantomsection\label{coverting-to-tidy-format-1}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{frame}[fragile]{Coverting to ``Tidy'' format}
\phantomsection\label{coverting-to-tidy-format-2}
...
\begin{frame}[fragile]{Coverting to ``Tidy'' format}
\phantomsection\label{coverting-to-tidy-format-3}
\normalsize
