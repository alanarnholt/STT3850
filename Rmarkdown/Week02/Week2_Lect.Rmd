...
Similarly, the following code will not display anything since the conditional statement is FALSE and hence R will not execute the R statements within the curl brackets.
...
- Spell check your **`first_quarto.qmd** document.  Did you have any typos?
