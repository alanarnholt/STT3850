...
\phantomsection\label{by-the-end-of-the-week}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{control-structures-in-r-1}
...
\phantomsection\label{conditional-statement}
\small
...
\phantomsection\label{conditional-statement-and-logical-operators}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Conditional Statement and Logical Operators}
\phantomsection\label{conditional-statement-and-logical-operators-1}
...
\begin{frame}[fragile]{Conditional Statement and Logical Operators}
\phantomsection\label{conditional-statement-and-logical-operators-2}
...
\phantomsection\label{if-statement}
...
statements within the curl brackets.
...
\phantomsection\label{if-statement-1}
...
\item
  ...
  \tightlist
  \item
    curly brackets are optional if there is only one R statement
  \end{itemize}
\item
...
\phantomsection\label{if-else-statement}
...
\begin{frame}[fragile]{If Else Statement}
\phantomsection\label{if-else-statement-1}
...
\phantomsection\label{if-else-if-statement}
...
\phantomsection\label{if-else-if-statement-1}
...
\begin{frame}[fragile]{If Else If Statement}
\phantomsection\label{if-else-if-statement-2}
...
\phantomsection\label{for-loop-statement}
...
\begin{frame}[fragile]{For Loop Statement}
\phantomsection\label{for-loop-statement-1}
...
\begin{frame}[fragile]{For Loop Statement}
\phantomsection\label{for-loop-statement-2}
\begin{itemize}
\item
...
\phantomsection\label{create-new-quarto-file}
...
\begin{frame}{Create New Quarto File}
\phantomsection\label{create-new-quarto-file-1}
...
\phantomsection\label{the-components-of-a-quarto-file-yaml}
...
\phantomsection\label{the-components-of-a-quarto-file-headers}
...
\phantomsection\label{the-components-of-quarto-file-emphasis}
\begin{itemize}
\item
...
\phantomsection\label{the-components-of-a-quarto-file-links}
\begin{itemize}
\item
...
\phantomsection\label{the-components-of-a-quarto-file-lists}
\begin{itemize}
\item
...
\phantomsection\label{the-components-of-a-quarto-file-equations}
\begin{itemize}
\item
...
\phantomsection\label{the-components-of-a-quarto-file-inline-r-code}
\begin{itemize}
\item
...
\phantomsection\label{the-components-of-a-quarto-file-chunk-options}
...
\begin{frame}[fragile]{The Components of a Quarto File: Chunk Options}
\phantomsection\label{the-components-of-a-quarto-file-chunk-options-1}
\begin{itemize}
\item
...
\phantomsection\label{spell-check}
\begin{itemize}
\item
...
\item
  Spell check your \textbf{`first\_quarto.qmd} document. Did you have
  any typos?
\end{itemize}
\end{frame}
...
\phantomsection\label{data-visualization-1}
...
\phantomsection\label{components-of-the-grammar}
...
\phantomsection\label{other-components}
...
\phantomsection\label{five-named-graphs---the-5ng}
...
\phantomsection\label{ng1-scatterplots}
...
\phantomsection\label{scatterplots-via-geom_point}
\tiny
...
\begin{frame}[fragile]{Scatterplots via \texttt{geom\_point}}
\phantomsection\label{scatterplots-via-geom_point-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}[fragile]{Scatterplots via \texttt{geom\_point}}
\phantomsection\label{scatterplots-via-geom_point-2}
\tiny
...
\phantomsection\label{overplotting}
...
\phantomsection\label{method-1-changing-the-transparency}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Method 1: Changing the transparency}
\phantomsection\label{method-1-changing-the-transparency-1}
\tiny
...
\phantomsection\label{method-2-jittering-the-points}
...
\begin{frame}{Method 2: Jittering the points}
\phantomsection\label{method-2-jittering-the-points-1}
\begin{itemize}
\item
...
\phantomsection\label{method-2-jittering-the-points-2}
\tiny
...
\phantomsection\label{ng2-linegraphs}
\begin{itemize}
\item
...
\phantomsection\label{linegraphs-via-geom_line}
\tiny
...
\phantomsection\label{ng3-histograms}
...
\phantomsection\label{ng3-histograms-1}
...
\phantomsection\label{histograms-via-geom_histogram}
\tiny
...
\begin{frame}[fragile]{Histograms via \texttt{geom\_histogram}}
\phantomsection\label{histograms-via-geom_histogram-1}
...
\begin{frame}[fragile]{Histograms via \texttt{geom\_histogram}}
\phantomsection\label{histograms-via-geom_histogram-2}
\tiny
...
\begin{frame}[fragile]{Histograms via \texttt{geom\_histogram}}
\phantomsection\label{histograms-via-geom_histogram-3}
\tiny
...
\phantomsection\label{adjusting-the-bins}
...
\begin{frame}[fragile]{Adjusting the bins}
\phantomsection\label{adjusting-the-bins-1}
...
\phantomsection\label{ng4-boxplots}
...
\begin{frame}{5NG\#4: Boxplots}
\phantomsection\label{ng4-boxplots-1}
\begin{itemize}
\item
...
\begin{frame}{5NG\#4: Boxplots}
\phantomsection\label{ng4-boxplots-2}
From the Boxplot:
...
\begin{frame}{5NG\#4: Boxplots}
\phantomsection\label{ng4-boxplots-3}
From the Boxplot:
...
specification}
\phantomsection\label{boxplots-via-geom_boxplot-invalid-specification}
\tiny
...
\phantomsection\label{boxplots-via-geom_boxplot}
\tiny
...
\phantomsection\label{ng5-barplots}
\begin{itemize}
\item
...
\phantomsection\label{ng5-barplots-1}
\begin{itemize}
\item
...
\begin{frame}[fragile]{5NG\#5: Barplots}
\phantomsection\label{ng5-barplots-2}
\tiny
...
\phantomsection\label{barplots-via-geom_bar}
\tiny
...
\phantomsection\label{barplots-via-geom_col}
\tiny
...
\phantomsection\label{barplots-for-flights-data}
...
\begin{frame}[fragile]{Barplots for \texttt{flights} data}
\phantomsection\label{barplots-for-flights-data-1}
\tiny
...
\phantomsection\label{pie-charts}
\begin{itemize}
\item
...
\phantomsection\label{cases-were-barplots-are-preferred}
...
\phantomsection\label{two-categorical-variables}
\begin{itemize}
\item
...
\phantomsection\label{two-categorical-variables-stacked-barplot}
\tiny
...
\begin{frame}[fragile]{Two categorical variables: Stacked barplot}
\phantomsection\label{two-categorical-variables-stacked-barplot-1}
\tiny
...
\phantomsection\label{two-categorical-variables-side-by-side-barplots}
...
\begin{frame}[fragile]{Two categorical variables: side-by-side barplots}
\phantomsection\label{two-categorical-variables-side-by-side-barplots-1}
\tiny
...
\begin{frame}[fragile]{Two categorical variables: side-by-side barplots}
\phantomsection\label{two-categorical-variables-side-by-side-barplots-2}
\tiny
...
\begin{frame}[fragile]{Two categorical variables: side-by-side barplots}
\phantomsection\label{two-categorical-variables-side-by-side-barplots-3}
Change order:
...
\phantomsection\label{two-categorical-variables-faceted-barplot}
\tiny
...
\phantomsection\label{summary-table}
\begin{figure}[h]
