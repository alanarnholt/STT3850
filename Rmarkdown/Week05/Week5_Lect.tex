...
\phantomsection\label{by-the-end-of-the-week-multiple-linear-regression}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{one-categorical-explanatory-variable-1}
\begin{itemize}
\item
...
\phantomsection\label{one-categorical-explanatory-variable-2}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-1}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-2}
...
# A tibble: 5 x 4
  ...
  <fct>       <dbl> <fct>         <dbl>
1 Canada       80.7 Americas     36319.
2 Singapore    80.0 Asia         47143.
3 Belgium      79.4 Europe       33693.
4 Peru         71.4 Americas      7409.
5 Thailand     70.6 Asia          7458.
\end{verbatim}
\end{frame}

\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-3}
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-4}
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-5}
\small
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-6}
\small
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-7}
\normalsize
...
\begin{frame}[fragile]{Linear regression}
\phantomsection\label{linear-regression-1}
...
\begin{frame}[fragile]{Linear regression}
\phantomsection\label{linear-regression-2}
...
\begin{frame}[fragile]{Linear regression}
\phantomsection\label{linear-regression-3}
...
\phantomsection\label{linear-regression-4}
...
\begin{frame}{Linear regression}
\phantomsection\label{linear-regression-5}
...
\phantomsection\label{multiple-regression-1}
...
variable}
\phantomsection\label{one-numerical-and-one-categorical-explanatory-variable}
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-8}
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-9}
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-10}
\normalsize
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-11}
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-12}
\normalsize
...
\phantomsection\label{exploratory-data-analysis-13}
\normalsize
\begin{figure}
...
\phantomsection\label{interaction-model}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Interaction model}
\phantomsection\label{interaction-model-1}
\small
...
\begin{frame}[fragile]{Interaction model}
\phantomsection\label{interaction-model-2}
...
\begin{frame}[fragile]{Interaction model}
\phantomsection\label{interaction-model-3}
...
\begin{frame}[fragile]{Interaction model}
\phantomsection\label{interaction-model-4}
...
\phantomsection\label{interaction-model-prediction}
...
\begin{frame}{Interaction model: Prediction}
\phantomsection\label{interaction-model-prediction-1}
...
\phantomsection\label{interaction-model-explanation}
\begin{itemize}
\item
...
\phantomsection\label{parallel-slopes-model}
...
\phantomsection\label{parallel-slopes-model-1}
\normalsize
...
\begin{frame}[fragile]{Parallel slopes model}
\phantomsection\label{parallel-slopes-model-2}
\small
...
\phantomsection\label{parallel-slopes-model-prediction}
Let's now write the equation for our regression lines, which we can use
to compute our fitted values
...
\begin{frame}{Parallel slopes model: Prediction}
\phantomsection\label{parallel-slopes-model-prediction-1}
Let's put this all together and compute the fitted
value\(\hat{y}=\widehat{\text{score}}\) for female instructors.
...
\phantomsection\label{interaction-model-and-parallel-slopes-model}
...
\begin{frame}[fragile]{Observed/fitted values and residuals}
\phantomsection\label{observedfitted-values-and-residuals-3}
...
variable}
\phantomsection\label{example-one-numerical-and-one-categorical-explanatory-variable}
\begin{tcolorbox}
...
\phantomsection\label{solution-is-there-a-realationship-between-totalprice-and-area}
\normalsize
...
\begin{frame}[fragile]{Solution (is there a realationship between
\texttt{totalprice} and \texttt{area}?):}
\phantomsection\label{solution-is-there-a-realationship-between-totalprice-and-area-1}
\scriptsize
...
\begin{frame}[fragile]{Solution (is there a realationship between
\texttt{totalprice} and \texttt{area}?):}
\phantomsection\label{solution-is-there-a-realationship-between-totalprice-and-area-2}
\normalsize
...
\phantomsection\label{solution-does-adding-a-dummy-variable-elevator-change-the-relationship}
\scriptsize
...
\begin{frame}[fragile]{Solution (does adding a dummy variable
(\texttt{elevator}) change the relationship?):}
\phantomsection\label{solution-does-adding-a-dummy-variable-elevator-change-the-relationship-1}
\scriptsize
...
\begin{frame}[fragile]{Solution (does adding a dummy variable
(\texttt{elevator}) change the relationship?):}
\phantomsection\label{solution-does-adding-a-dummy-variable-elevator-change-the-relationship-2}
\scriptsize
...
\phantomsection\label{diagnostic-plots}
\small
...
\phantomsection\label{two-numerical-explanatory-variables-1}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-14}
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-15}
\normalsize
...
1   387   371         3683   19.3           287    57
2   170  1099         6179   27.3           459    36
3   392   721         6555   73.3           472    43
4   321     5         1160   16.3           126    78
5   371   992         6135   35.6           466    40
\end{verbatim}
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-16}
\normalsize
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-17}
...
\begin{frame}[fragile]{Exploratory data analysis}
\phantomsection\label{exploratory-data-analysis-18}
\small
...
\phantomsection\label{exploratory-data-analysis-collinearity}
\begin{itemize}
\item
...
\phantomsection\label{exploratory-data-analysis-visualization}
...
\phantomsection\label{exploratory-data-analysis-visualization-1}
...
\begin{frame}[fragile]{Exploratory data analysis: visualization}
\phantomsection\label{exploratory-data-analysis-visualization-2}
...
\begin{frame}{Exploratory data analysis: visualization}
\phantomsection\label{exploratory-data-analysis-visualization-3}
...
\phantomsection\label{regression-plane}
\footnotesize
...
\phantomsection\label{regression-plane-interpretation}
\begin{itemize}
\item
...
\phantomsection\label{regression-plane-prediction}
...
\begin{frame}[fragile]{Diagnostic Plots}
\phantomsection\label{diagnostic-plots-1}
\normalsize
...
\begin{frame}[fragile]{Simpson's Paradox}
\phantomsection\label{simpsons-paradox-2}
\small
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0746}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1940}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2090}}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2985}}@{}}
\toprule\noalign{}
...
\begin{frame}[fragile]{Simpson's Paradox}
\phantomsection\label{simpsons-paradox-3}
\small
...
\begin{frame}[fragile]{Simpson's Paradox}
\phantomsection\label{simpsons-paradox-4}
\normalsize
...
\begin{frame}[fragile]{Simpson's Paradox}
\phantomsection\label{simpsons-paradox-5}
\normalsize
...
\phantomsection\label{simpsons-paradox-6}
