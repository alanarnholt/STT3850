...
* Download the file `TLP.xlsx` from asulearn and upload it to your account.  Use the package `readxl` along with the function `read_excel()` to read the excel spreadsheet into an R object named `DF`.
