...
Construct a 95% confidence interval for $\mu_{fp}- \mu_{mp}$ using the `infer` pipeline and 5000 bootstrap samples.
...
* Construct a 95% confidence interval for $\mu_{fp}- \mu_{mp}$ using a `for()` loop with 5000 bootstrap samples.
