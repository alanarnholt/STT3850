...
\begin{frame}{Background}
\phantomsection\label{background-1}
\begin{itemize}
\item
...
\phantomsection\label{background-2}
\begin{itemize}
\item
...
\begin{frame}{Background}
\phantomsection\label{background-3}
\begin{itemize}
\item
...
\begin{frame}{Background}
\phantomsection\label{background-4}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Background}
\phantomsection\label{background-5}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{soccer-example}
...
\phantomsection\label{soccer-solution}
\begin{itemize}
\tightlist
\item
...
\begin{frame}[fragile]{Soccer Solution}
\phantomsection\label{soccer-solution-1}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{PX[}\DecValTok{5}\SpecialCharTok{:}\DecValTok{7}\NormalTok{] }\CommentTok{\# Probabilities for categories 4, 5, and 6 or more}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
[1] 0.13360189 0.06680094 0.04202104
\end{verbatim}
\end{frame}

\begin{frame}[fragile]{Soccer Solution}
\phantomsection\label{soccer-solution-2}
\begin{tcolorbox}
...
\begin{frame}[fragile]{Soccer Solution}
\phantomsection\label{soccer-solution-3}
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ans}
\end{Highlighting}
...
\begin{frame}[fragile]{Soccer Solution}
\phantomsection\label{soccer-solution-4}
...
\begin{frame}[fragile]{Soccer Solution}
\phantomsection\label{soccer-solution-5}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Soccer Solution}
\phantomsection\label{soccer-solution-6}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{frame}[fragile]{Soccer Solution}
\phantomsection\label{soccer-solution-7}
\(1.3919402=\chi^2_{\text{obs}}\overset{?}{>}\chi^2_{0.95;6}=12.5915872\).

The \(\wp\text{-value}= 0.9663469\).
...
\phantomsection\label{soccer-solution-8}
\begin{itemize}
\item
  Since \(\chi^2_{\text{obs}}= 1.3919402\) is not greater than
  \(\chi^2_{0.95;6}=12.5915872\), fail to reject \(H_0\).
\item
  Since the \(\wp\text{-value}= 0.9663469\) is greater than 0.05, fail
  to reject \(H_0\).
\end{itemize}
\end{frame}

\begin{frame}{Soccer Solution}
\phantomsection\label{soccer-solution-9}
\begin{tcolorbox}
...
\begin{frame}[fragile]{Soccer Solution}
\phantomsection\label{soccer-solution-10}
...
\begin{frame}{Soccer Solution}
\phantomsection\label{soccer-solution-11}
...
\phantomsection\label{all-parameters-known}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{all-parameters-known-1}
...
\begin{frame}[fragile]{All Parameters Known}
\phantomsection\label{all-parameters-known-2}
\[
\begin{aligned}
...
\begin{frame}[fragile]{All Parameters Known}
\phantomsection\label{all-parameters-known-3}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{frame}[fragile]{All Parameters Known}
\phantomsection\label{all-parameters-known-4}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{all-parameters-known---conclusion}
\begin{tcolorbox}
Given the $\wp\text{-value}$ of $0.0118909$, evidence suggests birthdays for World Cup soccer players are not uniformly distributed.
\end{tcolorbox}
\end{frame}

\begin{frame}{All Parameters Known - Example 2}
\phantomsection\label{all-parameters-known---example-2}
...
\begin{frame}{All Parameters Known - Example 2}
\phantomsection\label{all-parameters-known---example-2-1}
...
\begin{frame}{All Parameters Known - Example 2}
\phantomsection\label{all-parameters-known---example-2-2}
...
\phantomsection\label{all-parameters-known---example-2-3}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sum}\NormalTok{(ps) }\CommentTok{\# check to make sure sum is 1}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{All Parameters Known - Example 2}
\phantomsection\label{all-parameters-known---example-2-4}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{frame}[fragile]{All Parameters Known - Example 2}
\phantomsection\label{all-parameters-known---example-2-5}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{all-parameters-known---example-2---conclusion}
\begin{tcolorbox}
If you test using $\alpha = 0.05$, you will fail to reject the null hypothesis since the $\wp\text{-value}= 0.0599978  > \alpha = 0.05$.  There is not convincing evidence that the data do not come from an Exp($\lambda = 1$).
\end{tcolorbox}
\end{frame}
...
\phantomsection\label{different-scenarios}
...
\phantomsection\label{scenario-one}
...
\phantomsection\label{scenario-one-1}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{scenario-one---expected-values}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{scenario-two}
...
\phantomsection\label{scenario-two-1}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{scenario-two---expected-values}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{categorical-data-1}
...
\begin{frame}{Categorical Data}
\phantomsection\label{categorical-data-2}
\begin{table}[!ht]
...
\phantomsection\label{categorial-data}
...
\begin{frame}{Categorical Data}
\phantomsection\label{categorical-data-3}
...
\begin{frame}{Categorical Data}
\phantomsection\label{categorical-data-4}
...
\begin{frame}{Categorical Data}
\phantomsection\label{categorical-data-5}
...
\begin{frame}{Scenario One}
\phantomsection\label{scenario-one-2}
...
\begin{frame}{Scenario One}
\phantomsection\label{scenario-one-3}
...
mathematical definition of independence and still be considered
statistically independent?'\,'
\end{frame}

\begin{frame}{Scenario One}
\phantomsection\label{scenario-one-4}
...
\begin{frame}{Scenario One}
\phantomsection\label{scenario-one-5}
...
\begin{frame}{Scenario One}
\phantomsection\label{scenario-one-6}
...
small. One rule of thumb is to require all \(E_{ij}\)s to be 5 or more.
This can be accomplished by combining cells with small \(E_{ij}\)s and
reducing the overall degrees of freedom.
\end{frame}

\begin{frame}{Test for Scenario One}
\phantomsection\label{test-for-scenario-one}
...
\begin{frame}{Test for Scenario One}
\phantomsection\label{test-for-scenario-one-1}
...
\begin{frame}{Test for Scenario One}
\phantomsection\label{test-for-scenario-one-2}
...
\(\chi^2_{\text{obs}}= \sum_{i=1}^I\sum_{j=1}^J
        \frac{(O_{ij} - E_{ij})^2}{E_{ij}}\) can be computed, the
...
\phantomsection\label{test-for-scenario-one-3}
...
\begin{frame}[fragile]{Test for Scenario One}
\phantomsection\label{test-for-scenario-one-4}
...
\begin{frame}[fragile]{Test for Scenario One}
\phantomsection\label{test-for-scenario-one-5}
...
\begin{frame}[fragile]{Test for Scenario One}
\phantomsection\label{test-for-scenario-one-6}
...
\phantomsection\label{expressed-in-words}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{equivalent-formulation}
\begin{tcolorbox}
...
\phantomsection\label{test-for-scenario-two}
...
\begin{frame}{Test for Scenario Two}
\phantomsection\label{test-for-scenario-two-1}
\textbf{Test Statistic}---The test statistic is
...
\begin{frame}{Test for Scenario Two}
\phantomsection\label{test-for-scenario-two-2}
\textbf{Rejection Region Calculations}---The rejection region is
...
\phantomsection\label{putting-the-data-back-in-a-tidy-format}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{more-output-for-scenario-two}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{xtabs}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{Pop }\SpecialCharTok{+}\NormalTok{ Status, }\AttributeTok{data =}\NormalTok{ NT) }\OtherTok{{-}\textgreater{}}\NormalTok{ T3}
\NormalTok{T3}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(E }\OtherTok{\textless{}{-}} \FunctionTok{chisq.test}\NormalTok{(T3)}\SpecialCharTok{$}\NormalTok{expected)}
\end{Highlighting}
\end{Shaded}
...
\phantomsection\label{test-for-scenario-two-3}
The value of the test statistic is \(\chi^2_{obs}=6.7584.\). This can be
done with code by entering

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{chi.obs }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{((T3 }\SpecialCharTok{{-}}\NormalTok{ E)}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\NormalTok{E )}
\NormalTok{chi.obs}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{Test for Scenario Two}
\phantomsection\label{test-for-scenario-two-4}
\textbf{Statistical Conclusion}---The \(\wp\text{-value}\) is 0.0340754.
...
\begin{frame}[fragile]{Test for Scenario Two}
\phantomsection\label{test-for-scenario-two-5}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{chisq.test}\NormalTok{(T3)}
\end{Highlighting}
\end{Shaded}
