...
\title{\texorpdfstring{STT 3850 : Week 4}{STT 3850 : Week 4}}
\author{\texorpdfstring{ATA}{ATA}}
\date{}
...
\protect\phantomsection\label{by-the-end-of-the-week-basic-regression}
\begin{itemize}
\tightlist
\item
  Data Modeling
...
\protect\phantomsection\label{basic-regression-1}
\begin{itemize}
\item
...
\protect\phantomsection\label{data-modeling}
...
\begin{frame}{Data Modeling}
\protect\phantomsection\label{data-modeling-1}
\begin{itemize}
\item
...
\protect\phantomsection\label{linear-regression}
\begin{itemize}
\item
...
\protect\phantomsection\label{needed-packages}
...
\protect\phantomsection\label{one-numerical-explanatory-variable}
\begin{itemize}
\item
...
\begin{frame}[fragile]{One numerical explanatory variable}
\protect\phantomsection\label{one-numerical-explanatory-variable-1}
...
\protect\phantomsection\label{one-numerical-explanatory-variable-2}
...
\protect\phantomsection\label{step-1-examine-the-raw-data-values}
\normalsize
...
\begin{frame}[fragile]{Step 1: Examine the raw data values}
\protect\phantomsection\label{step-1-examine-the-raw-data-values-1}
...
\protect\phantomsection\label{step-2-summary-statistics}
\normalsize
...
\begin{frame}[fragile]{Step 2: summary statistics}
\protect\phantomsection\label{step-2-summary-statistics-1}
...
\begin{center}\includegraphics[width=2.69in]{./pics/skim} \end{center}
\end{frame}

\begin{frame}{Correlation coefficient \(r\)}
\protect\phantomsection\label{correlation-coefficient-r}
...
\protect\phantomsection\label{properties-of-r}
\begin{itemize}
\item
...
\item
  ...
  \item
    0 indicates no linear relationship: The values of both variables go
    up/down independently of each other.
  \item
    +1 indicates a perfect positive linear relationship: As the value of
...
\protect\phantomsection\label{correlation-coefficient-and-scatterplot}
\begin{center}\includegraphics[width=0.9\linewidth,height=0.75\textheight]{week4_2} \end{center}
\end{frame}

\begin{frame}[fragile]{Correlation coefficient: GPA Example}
\protect\phantomsection\label{correlation-coefficient-gpa-example}
...
\begin{frame}[fragile]{Correlation coefficient: GPA Example}
\protect\phantomsection\label{correlation-coefficient-gpa-example-1}
\normalsize
...
\begin{center}\includegraphics[width=0.5\linewidth,height=0.5\textheight]{Week4_Lect_files/figure-beamer/unnamed-chunk-9-1} \end{center}
\normalsize
...
\begin{frame}[fragile]{Correlation coefficient: GPA Example}
\protect\phantomsection\label{correlation-coefficient-gpa-example-2}
\small
...
# A tibble: 10 x 6
 ...
 1   2.7     2.2 -0.5    -0.01000 -0.0210 -0.657
 2   3.1     2.8  0.1000  0.39     0.817   0.131
...
\begin{frame}[fragile]{Correlation coefficient: GPA Example}
\protect\phantomsection\label{correlation-coefficient-gpa-example-3}
\normalsize
...
\begin{frame}[fragile]{Correlation coefficient: GPA Example}
\protect\phantomsection\label{correlation-coefficient-gpa-example-4}
...
\begin{frame}[fragile]{Correlation coefficient: GPA Example}
\protect\phantomsection\label{correlation-coefficient-gpa-example-5}
\normalsize
...
\begin{center}\includegraphics[width=0.35\linewidth,height=0.4\textheight]{Week4_Lect_files/figure-beamer/unnamed-chunk-14-1} \end{center}
\normalsize
\end{frame}

\begin{frame}[fragile]{Correlation coefficient: Teaching Evaluations
Example}
\protect\phantomsection\label{correlation-coefficient-teaching-evaluations-example}
\normalsize
...
\protect\phantomsection\label{step-3-create-data-visualizations}
\normalsize
...
\protect\phantomsection\label{step-3-creating-data-visualizations}
...
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(evals\_ch5, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ bty\_avg, }\AttributeTok{y =}\NormalTok{ score)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{size =} \DecValTok{3}\NormalTok{, }\AttributeTok{color =} \StringTok{"purple"}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.2}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Beauty Score"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Teaching Score"}\NormalTok{,}
...
\protect\phantomsection\label{simple-linear-regression-1}
...
\begin{frame}{Simple linear regression}
\protect\phantomsection\label{simple-linear-regression-2}
...
\begin{frame}{Simple linear regression}
\protect\phantomsection\label{simple-linear-regression-3}
...
\protect\phantomsection\label{the-least-squares-regression-line}
...
\protect\phantomsection\label{regression-teaching-evaluations-example}
\begin{center}\includegraphics[width=0.6\linewidth,height=0.45\textheight]{Week4_Lect_files/figure-beamer/unnamed-chunk-19-1} \end{center}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-1}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-2}
\small
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Make it look better}
\FunctionTok{get\_regression\_table}\NormalTok{(score\_model) }\SpecialCharTok{|\textgreater{}} 
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-3}
\small
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-4}
\small
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-5}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-6}
\begin{itemize}
\item
...
\protect\phantomsection\label{observedfitted-values-and-residuals}
...
\protect\phantomsection\label{observedfitted-values-and-residuals-1}
...
\begin{frame}[fragile]{Observed/fitted values and residuals}
\protect\phantomsection\label{observedfitted-values-and-residuals-2}
...
\protect\phantomsection\label{assessing-the-fit}
\begin{itemize}
\item
...
\begin{frame}{Assessing the fit}
\protect\phantomsection\label{assessing-the-fit-1}
\begin{center}\includegraphics[width=0.9\linewidth]{Week4_Lect_files/figure-beamer/unnamed-chunk-26-1} \end{center}
\end{frame}

\begin{frame}[fragile]{Assessing the fit: Teaching Evaluations Example}
\protect\phantomsection\label{assessing-the-fit-teaching-evaluations-example}
\normalsize
...
\begin{center}\includegraphics[width=0.8\linewidth,height=0.6\textheight]{Week4_Lect_files/figure-beamer/unnamed-chunk-27-1} \end{center}
\normalsize
\end{frame}
...
\protect\phantomsection\label{estimating-sigma2}
...
\begin{frame}{Estimating \(\sigma^2\)}
\protect\phantomsection\label{estimating-sigma2-1}
...
\protect\phantomsection\label{properties-of-ols}
...
\protect\phantomsection\label{confidence-intervals}
...
\protect\phantomsection\label{hypothesis-tests}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Hypothesis Tests}
\protect\phantomsection\label{hypothesis-tests-1}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-7}
\small
...
\NormalTok{score\_model }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(score }\SpecialCharTok{\textasciitilde{}}\NormalTok{ bty\_avg, }\AttributeTok{data =}\NormalTok{ evals\_ch5)}
\CommentTok{\# Get regression table:}
\FunctionTok{get\_regression\_table}\NormalTok{(score\_model, }\AttributeTok{conf.level =} \FloatTok{0.95}\NormalTok{) }\SpecialCharTok{|\textgreater{}} 
\NormalTok{  knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-8}
\small
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-9}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-10}
\normalsize
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-11}
\normalsize
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-12}
\normalsize
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-13}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{partition-of-total-sum-of-squares}
\begin{itemize}
\item
...
\begin{frame}{Partition of Total sum of squares}
\protect\phantomsection\label{partition-of-total-sum-of-squares-1}
\begin{itemize}
\item
...
\protect\phantomsection\label{coefficient-of-determination}
...
\begin{frame}{Coefficient of Determination}
\protect\phantomsection\label{coefficient-of-determination-1}
...
\begin{frame}{Coefficient of Determination}
\protect\phantomsection\label{coefficient-of-determination-2}
\begin{center}\includegraphics[width=0.6\linewidth]{week2_7} \end{center}
\end{frame}

\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-14}
\normalsize
...
\begin{Highlighting}[]
\CommentTok{\# Or}
\NormalTok{broom}\SpecialCharTok{::}\FunctionTok{glance}\NormalTok{(score\_model)}\SpecialCharTok{$}\NormalTok{r.squared}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-15}
\normalsize
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-16}
\small
...
Response}
\protect\phantomsection\label{interval-estimation-for-mean-response-and-a-single-response}
\begin{enumerate}
\tightlist
\item
...
\protect\phantomsection\label{interval-estimation-of-mean-response}
...
\begin{frame}{Interval Estimation of Mean Response}
\protect\phantomsection\label{interval-estimation-of-mean-response-1}
\begin{itemize}
\tightlist
\item
  \(t-\)distribution
...
\protect\phantomsection\label{prediction-intervals-for-a-single-response}
...
\begin{frame}{Prediction Intervals for a Single Response}
\protect\phantomsection\label{prediction-intervals-for-a-single-response-1}
Hence,
...
\protect\phantomsection\label{confidence-regions-and-prediction-bands}
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{confidence-regions-and-prediction-bands-1}
\begin{center}\includegraphics[width=0.7\linewidth,height=0.7\textheight]{Week4_Lect_files/figure-beamer/unnamed-chunk-41-1} \end{center}
\end{frame}

\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\protect\phantomsection\label{regression-teaching-evaluations-example-17}
\normalsize
...
\protect\phantomsection\label{correlation-is-not-necessarily-causation}
\begin{itemize}
\item
...
\protect\phantomsection\label{correlation-is-not-necessarily-causation-1}
...
\begin{frame}{Correlation is not necessarily causation}
\protect\phantomsection\label{correlation-is-not-necessarily-causation-2}
\begin{itemize}
\item
...
\begin{frame}{Correlation is not necessarily causation}
\protect\phantomsection\label{correlation-is-not-necessarily-causation-3}
\begin{itemize}
\item
...
\protect\phantomsection\label{best-fitting-line}
...
\begin{frame}{Best-fitting line}
\protect\phantomsection\label{best-fitting-line-1}
\begin{itemize}
\item
...
\protect\phantomsection\label{best-fitting-line-2}
\normalsize
...
\begin{frame}[fragile]{Best-fitting line}
\protect\phantomsection\label{best-fitting-line-3}
...
\begin{frame}[fragile]{Best-fitting line}
\protect\phantomsection\label{best-fitting-line-4}
