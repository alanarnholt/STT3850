...
\phantomsection\label{by-the-end-of-the-week-basic-regression}
\begin{itemize}
\tightlist
\item
  Data Modeling
...
\phantomsection\label{basic-regression-1}
\begin{itemize}
\item
...
\phantomsection\label{data-modeling}
...
\begin{frame}{Data Modeling}
\phantomsection\label{data-modeling-1}
\begin{itemize}
\item
...
\phantomsection\label{one-numerical-explanatory-variable}
\begin{itemize}
\item
...
\begin{frame}[fragile]{One numerical explanatory variable}
\phantomsection\label{one-numerical-explanatory-variable-1}
...
\phantomsection\label{one-numerical-explanatory-variable-2}
...
\phantomsection\label{exploratory-data-analysis}
\begin{itemize}
\item
...
\phantomsection\label{step-1-examine-the-raw-data-values}
\normalsize
...
\begin{frame}[fragile]{Step 1: Examine the raw data values}
\phantomsection\label{step-1-examine-the-raw-data-values-1}
...
\phantomsection\label{step-2-summary-statistics}
\normalsize
...
\begin{frame}[fragile]{Step 2: summary statistics}
\phantomsection\label{step-2-summary-statistics-1}
...
\phantomsection\label{correlation-coefficient-r}
...
\phantomsection\label{properties-of-r}
\begin{itemize}
\item
...
\phantomsection\label{correlation-coefficient-and-scatterplot}
...
\phantomsection\label{correlation-coefficien-gpa-example}
...
\phantomsection\label{correlation-coefficient-gpa-example}
\normalsize
...
\begin{frame}[fragile]{Correlation coefficien: GPA Example}
\phantomsection\label{correlation-coefficien-gpa-example-1}
\small
...
\begin{frame}[fragile]{Correlation coefficient: GPA Example}
\phantomsection\label{correlation-coefficient-gpa-example-1}
\normalsize
...
\begin{frame}[fragile]{Correlation coefficient: GPA Example}
\phantomsection\label{correlation-coefficient-gpa-example-2}
...
\begin{frame}[fragile]{Correlation coefficient: GPA Example}
\phantomsection\label{correlation-coefficient-gpa-example-3}
\normalsize
...
Example}
\phantomsection\label{correlation-coefficient-teaching-evaluations-example}
\normalsize
...
\phantomsection\label{step-3-create-data-visualizations}
\normalsize
...
\phantomsection\label{step-3-creating-data-visualizations}
...
\phantomsection\label{simple-linear-regression-1}
...
\begin{frame}{Simple linear regression}
\phantomsection\label{simple-linear-regression-2}
...
\begin{frame}{Simple linear regression}
\phantomsection\label{simple-linear-regression-3}
...
\phantomsection\label{the-least-squares-regression-line}
...
\phantomsection\label{regression-teaching-evaluations-example}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-1}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-2}
\small
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-3}
\small
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-4}
\small
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-5}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-6}
\begin{itemize}
\item
...
\phantomsection\label{observedfitted-values-and-residuals}
...
\phantomsection\label{observedfitted-values-and-residuals-1}
...
\begin{frame}[fragile]{Observed/fitted values and residuals}
\phantomsection\label{observedfitted-values-and-residuals-2}
...
\phantomsection\label{assessing-the-fit}
\begin{itemize}
\item
...
\begin{frame}{Assessing the fit}
\phantomsection\label{assessing-the-fit-1}
...
\phantomsection\label{assessing-the-fit-teaching-evaluations-example}
\normalsize
...
\begin{frame}{Estimating \(\sigma^2\)}
\phantomsection\label{estimating-sigma2-1}
...
\phantomsection\label{properties-of-ols}
...
\phantomsection\label{hypothesis-tests}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Hypothesis Tests}
\phantomsection\label{hypothesis-tests-1}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-7}
\small
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-8}
\small
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-9}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-10}
\normalsize
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-11}
\normalsize
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-12}
\normalsize
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-13}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{partition-of-total-sum-of-squares}
\begin{itemize}
\item
...
\begin{frame}{Partition of Total sum of squares}
\phantomsection\label{partition-of-total-sum-of-squares-1}
\begin{itemize}
\item
...
\phantomsection\label{coefficient-of-determination}
...
\begin{frame}{Coefficient of Determination}
\phantomsection\label{coefficient-of-determination-1}
...
\begin{frame}{Coefficient of Determination}
\phantomsection\label{coefficient-of-determination-2}
\begin{center}\includegraphics[width=0.6\linewidth]{week2_7} \end{center}
\end{frame}

\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-14}
\normalsize
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-15}
\normalsize
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-16}
\small
...
Response}
\phantomsection\label{interval-estimation-for-mean-response-and-a-single-response}
\begin{enumerate}
\tightlist
\item
...
\phantomsection\label{interval-estimation-of-mean-response}
...
\begin{frame}{Interval Estimation of Mean Response}
\phantomsection\label{interval-estimation-of-mean-response-1}
\begin{itemize}
\tightlist
\item
  \(t-\)distribution
...
\phantomsection\label{prediction-intervals-for-a-single-response}
...
\begin{frame}{Prediction Intervals for a Single Response}
\phantomsection\label{prediction-intervals-for-a-single-response-1}
Hence,
...
\phantomsection\label{confidence-regions-and-prediction-bands}
\begin{Shaded}
\begin{Highlighting}[]
...
\phantomsection\label{confidence-regions-and-prediction-bands-1}
...
\begin{frame}[fragile]{Regression: Teaching Evaluations Example}
\phantomsection\label{regression-teaching-evaluations-example-17}
\normalsize
...
\phantomsection\label{correlation-is-not-necessarily-causation}
\begin{itemize}
\item
...
\phantomsection\label{correlation-is-not-necessarily-causation-1}
...
\begin{frame}{Correlation is not necessarily causation}
\phantomsection\label{correlation-is-not-necessarily-causation-2}
\begin{itemize}
\item
...
\begin{frame}{Correlation is not necessarily causation}
\phantomsection\label{correlation-is-not-necessarily-causation-3}
\begin{itemize}
\item
...
\phantomsection\label{best-fitting-line}
...
\begin{frame}{Best-fitting line}
\phantomsection\label{best-fitting-line-1}
\begin{itemize}
\item
...
\phantomsection\label{best-fitting-line-2}
\normalsize
...
\begin{frame}[fragile]{Best-fitting line}
\phantomsection\label{best-fitting-line-3}
...
\begin{frame}[fragile]{Best-fitting line}
\phantomsection\label{best-fitting-line-4}
