...
\begin{center}\includegraphics{Week4_Lect_files/figure-beamer/unnamed-chunk-14-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics{Week4_Lect_files/figure-beamer/unnamed-chunk-17-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.5\linewidth,height=0.5\textheight]{Week4_Lect_files/figure-beamer/unnamed-chunk-18-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.5\linewidth,height=0.5\textheight]{Week4_Lect_files/figure-beamer/unnamed-chunk-19-1} \end{center}
\normalsize
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"Week4\_3.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"week4\_4.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
