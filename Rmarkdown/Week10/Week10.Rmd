...
- Example: Consider a random sample of size 49 drawn from a $N(25,7)$. 
    ...
    - Theory tells us that that the sampling distribution of the sample means is normal with mean 25 and standard error $\sigma=7/\sqrt{49}=1$. 
...
\tiny
```{r echo=TRUE, eval=FALSE, warning=FALSE, message=FALSE,out.height = '40%',out.width = '70%', fig.align='center'}
set.seed(11)
par(mfrow = c(3, 2))
...
\tiny
```{r echo=FALSE, warning=FALSE, message=FALSE,out.height = '85%',out.width = '90%', fig.align='center'}
set.seed(11)
par(mfrow = c(3, 2))
curve(dnorm(x, 25, 7), from = 25 - 2.5*7, 25 + 2.5*7, col = "blue", main = "N(25, 7)", ylab = "", xlab = "")
abline(v = 25, col = "red")
...
knitr::include_graphics("week10_8.png")
```
\normalsize
...
\tiny
```{r echo=TRUE, warning=FALSE, message=FALSE,out.height = '85%',out.width = '90%', fig.align='center'}
set.seed(10)
...
\tiny
```{r echo=FALSE, warning=FALSE, message=FALSE,out.height = '40%',out.width = '70%', fig.align='center'}
knitr::include_graphics("week10_8.png")
```
\normalsize
...
In this case the $95\%$ confidence interval for $p$, (0.3,0.56),  based on their sample contain the true value of of 0.375. 
...
- Now let’s generate a figure similar to Figure above, but this time constructing $80\%$ confidence intervals instead.
 ...
 \tiny
```{r warning=FALSE, message=FALSE,out.height = '50%',out.width = '60%', fig.align='center'}
...
- In general, bootstrapping should mimic how the data were obtained. 
    ...
    - So the data correspond to independent samples from two populations, we should draw to samples that way. 
