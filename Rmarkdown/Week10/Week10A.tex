...
Intervals}
\phantomsection\label{by-the-end-of-the-week-bootstrapping-and-confidence-intervals}
\begin{itemize}
\item
...
\phantomsection\label{needed-packages}
\small
...
\phantomsection\label{key-features-of-the-bootstrap-example-1}
...
\phantomsection\label{key-features-of-the-bootstrap-example-1-1}
\tiny
...
\begin{frame}[fragile]{Key features of the Bootstrap: Example 1}
\phantomsection\label{key-features-of-the-bootstrap-example-1-2}
\tiny
...
\begin{frame}{Key features of the Bootstrap: Example 1}
\phantomsection\label{key-features-of-the-bootstrap-example-1-3}
\begin{itemize}
\item
...
\begin{frame}{Key features of the Bootstrap: Example 1}
\phantomsection\label{key-features-of-the-bootstrap-example-1-4}
\begin{itemize}
\item
...
\phantomsection\label{key-features-of-the-bootstrap-example-2}
...
\phantomsection\label{key-features-of-the-bootstrap-example-2-1}
\tiny
...
\begin{frame}{Key features of the Bootstrap: Example 2}
\phantomsection\label{key-features-of-the-bootstrap-example-2-2}
\tiny
...
\begin{frame}{Key features of the Bootstrap: Example 2}
\phantomsection\label{key-features-of-the-bootstrap-example-2-3}
\begin{itemize}
\item
...
\phantomsection\label{key-features-of-the-bootstrap-1}
...
\begin{frame}{Key features of the Bootstrap}
\phantomsection\label{key-features-of-the-bootstrap-2}
\begin{itemize}
\item
...
\phantomsection\label{key-features-of-the-bootstrap-example-3}
\begin{tcolorbox}
...
\phantomsection\label{key-features-of-the-bootstrap-example-3-1}
\tiny
...
\begin{frame}{Key features of the Bootstrap: Example 3}
\phantomsection\label{key-features-of-the-bootstrap-example-3-2}
\tiny
...
\begin{frame}{Key features of the Bootstrap: Example 3}
\phantomsection\label{key-features-of-the-bootstrap-example-3-3}
\begin{itemize}
\item
...
\phantomsection\label{understanding-confidence-intervals-1}
\begin{itemize}
\item
...
\phantomsection\label{understanding-confidence-intervals-2}
\begin{itemize}
\item
...
\begin{frame}{Understanding confidence intervals}
\phantomsection\label{understanding-confidence-intervals-3}
\begin{itemize}
\item
...
\phantomsection\label{percentile-method}
\small
...
\begin{frame}[fragile]{Percentile method}
\phantomsection\label{percentile-method-1}
\small
...
\phantomsection\label{percentile-method-2}
...
\phantomsection\label{standard-error-method}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Standard error method}
\phantomsection\label{standard-error-method-1}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{frame}[fragile]{Standard error method}
\phantomsection\label{standard-error-method-2}
...
\phantomsection\label{standard-error-method-vs.-percentile-method}
\begin{itemize}
\item
...
\phantomsection\label{percentile-method-example-pennies-activity}
...
\begin{frame}[fragile]{Percentile method example: Pennies Activity}
\phantomsection\label{percentile-method-example-pennies-activity-1}
Using \texttt{rep\_sample\_n} from the \texttt{infer} package.
...
\begin{frame}[fragile]{Percentile method example: Pennies Activity}
\phantomsection\label{percentile-method-example-pennies-activity-2}
...
\begin{frame}[fragile]{Percentile method example: Pennies Activity}
\phantomsection\label{percentile-method-example-pennies-activity-3}
Using the \texttt{infer} pipeline
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.4\textheight]{Week10A_files/figure-beamer/unnamed-chunk-15-1} \end{center}
\normalsize
\end{frame}

\begin{frame}[fragile]{Standard error example: Pennies Activity}
\phantomsection\label{standard-error-example-pennies-activity}
Using the \texttt{infer} pipeline
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.4\textheight]{Week10A_files/figure-beamer/unnamed-chunk-16-1} \end{center}
\normalsize
\end{frame}

\begin{frame}[fragile]{Percentile method example: Birth weight of a
baby}
\phantomsection\label{percentile-method-example-birth-weight-of-a-baby}
Using the \texttt{infer} pipeline
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.45\textheight]{Week10A_files/figure-beamer/unnamed-chunk-17-1} \end{center}
\normalsize
\end{frame}

\begin{frame}[fragile]{Percentile method example: Birth weight of a
baby}
\phantomsection\label{percentile-method-example-birth-weight-of-a-baby-1}
Using the \texttt{infer} pipeline
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.45\textheight]{Week10A_files/figure-beamer/unnamed-chunk-18-1} \end{center}
\normalsize
\end{frame}

\begin{frame}[fragile]{Standard error example: Birth weight of a baby}
\phantomsection\label{standard-error-example-birth-weight-of-a-baby}
Using the \texttt{infer} pipeline
...
\phantomsection\label{interpreting-confidence-intervals-1}
\begin{itemize}
\item
...
\phantomsection\label{interpreting-confidence-intervals-2}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Interpreting confidence intervals}
\phantomsection\label{interpreting-confidence-intervals-3}
\begin{itemize}
\item
...
\phantomsection\label{percentile-method-example-sampling-bowl-example}
Using the \texttt{infer} pipeline
...
\begin{frame}[fragile]{Percentile method example: sampling bowl example}
\phantomsection\label{percentile-method-example-sampling-bowl-example-1}
Using the \texttt{infer} pipeline
...
\phantomsection\label{interpreting-confidence-intervals-sampling-bowl-example}
\begin{itemize}
\item
...
\begin{frame}{Interpreting confidence intervals: Sampling bowl example}
\phantomsection\label{interpreting-confidence-intervals-sampling-bowl-example-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Interpreting confidence intervals}
\phantomsection\label{interpreting-confidence-intervals-4}
...
\phantomsection\label{width-of-confidence-intervals}
...
\phantomsection\label{two-sample-boostrap-1}
...
\begin{frame}{Two Sample Boostrap}
\phantomsection\label{two-sample-boostrap-2}
...
\phantomsection\label{tv-example}
\begin{tcolorbox}
...
\begin{frame}[fragile]{TV example}
\phantomsection\label{tv-example-1}
\small
...
\phantomsection\label{tv-example-2}
\begin{itemize}
\item
...
\begin{frame}[fragile]{TV example}
\phantomsection\label{tv-example-3}
\tiny
...
\begin{frame}[fragile]{TV example}
\phantomsection\label{tv-example-4}
\tiny
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.43\textheight]{Week10A_files/figure-beamer/unnamed-chunk-29-1} \end{center}
...
\begin{frame}{TV example}
\phantomsection\label{tv-example-5}
\begin{itemize}
\item
...
\begin{frame}[fragile]{TV example}
\phantomsection\label{tv-example-6}
Using the \texttt{infer} pipeline
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.45\textheight]{Week10A_files/figure-beamer/unnamed-chunk-30-1} \end{center}
\normalsize
\end{frame}

\begin{frame}[fragile]{TV example}
\phantomsection\label{tv-example-7}
Using the \texttt{infer} pipeline
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.38\textheight]{Week10A_files/figure-beamer/unnamed-chunk-31-1} \end{center}
\normalsize
\end{frame}

\begin{frame}{Verizon example}
\phantomsection\label{verizon-example}
\begin{tcolorbox}
...
\phantomsection\label{verizon-example-1}
\normalsize
...
\begin{frame}[fragile]{Verizon example}
\phantomsection\label{verizon-example-2}
\tiny
...
\begin{frame}[fragile]{Verizon example}
\phantomsection\label{verizon-example-3}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Verizon example}
\phantomsection\label{verizon-example-4}
...
\begin{frame}[fragile]{Verizon example}
\phantomsection\label{verizon-example-5}
\begin{itemize}
\tightlist
\item
...
\begin{frame}[fragile]{Verizon example}
\phantomsection\label{verizon-example-6}
...
\begin{frame}[fragile]{Verizon example}
\phantomsection\label{verizon-example-7}
Distribution of the difference:
...
\begin{frame}{Verizon example}
\phantomsection\label{verizon-example-8}
\begin{itemize}
\item
...
\phantomsection\label{other-statistics}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Verizon example}
\phantomsection\label{verizon-example-9}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Verizon example}
\phantomsection\label{verizon-example-10}
\tiny
...
\phantomsection\label{mythbusters-example}
\begin{tcolorbox}
...
\begin{frame}[fragile]{Mythbusters example}
\phantomsection\label{mythbusters-example-1}
\small
...
\begin{frame}[fragile]{Mythbusters example}
\phantomsection\label{mythbusters-example-2}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10A_files/figure-beamer/unnamed-chunk-42-1} \end{center}
\normalsize
\end{frame}

\begin{frame}[fragile]{Mythbusters example}
\phantomsection\label{mythbusters-example-3}
...
\begin{frame}[fragile]{Mythbusters example}
\phantomsection\label{mythbusters-example-4}
Compute a \(95\%\) confidence interval for \(p_{seed}-p_{control}\)
...
\begin{frame}[fragile]{Mythbusters example}
\phantomsection\label{mythbusters-example-5}
\tiny
...
\phantomsection\label{theory-based-confidence-intervals-1}
\begin{itemize}
\item
...
\phantomsection\label{confidence-intervals-for-a-mean-sigma-known}
\begin{tcolorbox}
...
\begin{frame}{Confidence intervals for a Mean, \(\sigma\) known}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-known-1}
...
\begin{frame}{Confidence intervals for a Mean, \(\sigma\) known}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-known-2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Confidence intervals for a Mean, \(\sigma\) known}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-known-3}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Confidence intervals for a Mean, \(\sigma\) known}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-known-4}
...
known}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-known-5}
\normalsize
...
\begin{frame}[fragile]{Confidence intervals for a Mean, \(\sigma\)
known}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-known-6}
...
\begin{frame}[fragile]{Confidence intervals for a Mean, \(\sigma\)
known}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-known-7}
\normalsize
...
\begin{frame}{Example 2}
\phantomsection\label{example-2-1}
\begin{tcolorbox}
Solution: 
\begin{itemize}
...
\phantomsection\label{example-3-1}
\small
...
\phantomsection\label{example-4-1}
\normalsize
...
\phantomsection\label{confidence-intervals-for-a-mean-sigma-unknown}
...
\begin{frame}[fragile]{Confidence intervals for a Mean, \(\sigma\)
unknown}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-unknown-1}
\tiny
...
\begin{frame}[fragile]{Confidence intervals for a Mean, \(\sigma\)
unknown}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-unknown-2}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10A_files/figure-beamer/unnamed-chunk-53-1} \end{center}
\normalsize
...
\begin{frame}{Confidence intervals for a Mean, \(\sigma\) unknown}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-unknown-3}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Confidence intervals for a Mean, \(\sigma\)
unknown}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-unknown-4}
\tiny
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10A_files/figure-beamer/unnamed-chunk-54-1} \end{center}
\normalsize
\end{frame}

\begin{frame}[fragile]{Confidence intervals for a Mean, \(\sigma\)
unknown}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-unknown-5}
with \texttt{ggplot2}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10A_files/figure-beamer/unnamed-chunk-55-1} \end{center}
\normalsize
\end{frame}

\begin{frame}{Confidence intervals for a Mean, \(\sigma\) unknown}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-unknown-6}
...
\begin{frame}{Confidence intervals for a Mean, \(\sigma\) unknown}
\phantomsection\label{confidence-intervals-for-a-mean-sigma-unknown-7}
...
\begin{frame}[fragile]{Example 5}
\phantomsection\label{example-5-1}
...
\phantomsection\label{example-5-birth-weight-of-a-baby}
\begin{tcolorbox}
...
\begin{frame}[fragile]{Example 5: Birth weight of a baby}
\phantomsection\label{example-5-birth-weight-of-a-baby-1}
\normalsize
...
\begin{frame}[fragile]{Example 5: Birth weight of a baby}
\phantomsection\label{example-5-birth-weight-of-a-baby-2}
...
\begin{frame}[fragile]{Example 5: Birth weight of a baby}
\phantomsection\label{example-5-birth-weight-of-a-baby-3}
\tiny
...
\begin{frame}[fragile]{Example 5: Birth weight of a baby}
\phantomsection\label{example-5-birth-weight-of-a-baby-4}
...
\begin{frame}[fragile]{Example 5: Birth weight of a baby}
\phantomsection\label{example-5-birth-weight-of-a-baby-5}
\normalsize
...
\begin{frame}[fragile]{Example 5: Birth weight of a baby}
\phantomsection\label{example-5-birth-weight-of-a-baby-6}
...
\phantomsection\label{assumptions-underlying-t-confidence-interval}
...
\begin{frame}{Assumptions underlying \(t\)-confidence interval}
\phantomsection\label{assumptions-underlying-t-confidence-interval-1}
\begin{itemize}
\item
...
\phantomsection\label{assumptions-underlying-t-confidence-interval-2}
\begin{tcolorbox}
...
\begin{frame}[fragile]{Assumptions underlying \(t\)-confidence interval}
\phantomsection\label{assumptions-underlying-t-confidence-interval-3}
\tiny
...
\begin{frame}{Assumptions underlying \(t\)-confidence interval}
\phantomsection\label{assumptions-underlying-t-confidence-interval-4}
\begin{itemize}
\item
...
\begin{frame}[fragile]{Assumptions underlying \(t\)-confidence interval}
\phantomsection\label{assumptions-underlying-t-confidence-interval-5}
\tiny
...
\begin{frame}{Assumptions underlying \(t\)-confidence interval}
\phantomsection\label{assumptions-underlying-t-confidence-interval-6}
\tiny

\begin{center}\includegraphics[width=0.8\linewidth,height=0.5\textheight]{Week10A_files/figure-beamer/unnamed-chunk-67-1} \end{center}
\normalsize
...
\begin{frame}[fragile]{Assumptions underlying \(t\)-confidence interval}
\phantomsection\label{assumptions-underlying-t-confidence-interval-7}
\tiny
...
\begin{frame}{Assumptions underlying \(t\)-confidence interval}
\phantomsection\label{assumptions-underlying-t-confidence-interval-8}
\tiny

\begin{center}\includegraphics[width=0.8\linewidth,height=0.5\textheight]{Week10A_files/figure-beamer/unnamed-chunk-69-1} \end{center}
\normalsize
...
\begin{frame}{Assumptions underlying \(t\)-confidence interval}
\phantomsection\label{assumptions-underlying-t-confidence-interval-9}
\begin{itemize}
\item
