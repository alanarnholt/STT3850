...
\urlstyle{same}
\hypersetup{
  pdftitle={MAT 3850 : Week 10},
  pdfauthor={Fall 2023},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{MAT 3850 : Week 10}
\author{Fall 2023}
\date{}
\institute{App State}
...
\begin{itemize}
\item
  we begin with two examples in which the theoretical sampling
  distributions of the mean are known.
\item
...
\begin{center}\includegraphics[width=0.9\linewidth,height=0.85\textheight]{Week10_files/figure-beamer/unnamed-chunk-3-1} \end{center}
\normalsize
\end{frame}
...
\item
  ...
  \item
    \(s_1= 0.8458991\) and, \(s_2=0.941966\)
  \end{itemize}
\item
...
\begin{center}\includegraphics[width=0.9\linewidth,height=0.85\textheight]{Week10_files/figure-beamer/unnamed-chunk-5-1} \end{center}
\normalsize
\end{frame}
...
\item
  ...
  \tightlist
  \item
    \(\bar{x}_1=1.53899\) and, \(\bar{x}_2=2.315282\)
  \item
    \(s_1= 0.3849037\) and, \(s_2=0.478826\)
  \end{itemize}
\item
  Based on the graphs above, we can see that the bootstrap distribution:
...
\NormalTok{\}}
\FunctionTok{hist}\NormalTok{(arsenic.mean, }\AttributeTok{main =} \StringTok{"Figure 2a"}\NormalTok{, }\AttributeTok{col =} \StringTok{"lightblue"}\NormalTok{, }\AttributeTok{breaks =} \StringTok{"Scott"}\NormalTok{, }\AttributeTok{xlab =} \FunctionTok{substitute}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\FunctionTok{bar}\NormalTok{(X),}\StringTok{"*"}\NormalTok{)))}
...
\begin{center}\includegraphics[width=0.9\linewidth,height=0.85\textheight]{Week10_files/figure-beamer/unnamed-chunk-7-1} \end{center}
\normalsize
\end{frame}
...
\item
  Based on our sample of 50 pennies from the bank, the sample mean was
  1995.44.
...
\item
  ...
  \end{itemize}
\item
  Let's mark these percentiles on the bootstrap distribution with
  vertical lines in Figure below:
\end{itemize}

\tiny

\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{week10_8} \end{center}
\normalsize
\end{frame}
...
\item
  ...
  replacement in Figure above is normally shaped,
...
&=(1995.44-1.96\cdot 2.15, 1995.44+1.96\cdot2.15)\\
&=(1991.15,1999.73)
\end{array}\]
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.4\textheight]{week10_8} \end{center}
\normalsize
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.5\textheight]{Week10_files/figure-beamer/unnamed-chunk-12-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.5\textheight]{Week10_files/figure-beamer/unnamed-chunk-14-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-15-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-16-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.45\textheight]{Week10_files/figure-beamer/unnamed-chunk-17-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.45\textheight]{Week10_files/figure-beamer/unnamed-chunk-18-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-19-1} \end{center}
\normalsize
\end{frame}
...
\NormalTok{sample\_1\_bootstrap }\OtherTok{\textless{}{-}}\NormalTok{ bowl\_sample\_1 }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{specify}\NormalTok{(}\AttributeTok{response =}\NormalTok{ color, }\AttributeTok{success =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \DocumentationTok{\#\# need to specify the color}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.45\textheight]{Week10_files/figure-beamer/unnamed-chunk-23-1} \end{center}
\normalsize

In this case the \(95\%\) confidence interval for \(p\), (0.3,0.56),
based on their sample contain the true value of of 0.375.
\end{frame}
...
\tightlist
\item
  Now let's generate a figure similar to Figure above, but this time
  constructing \(80\%\) confidence intervals instead.
\end{itemize}
...
\item
  ...
  \item
    ...
    we should draw to samples that way.
  \end{itemize}
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{times.Basic }\OtherTok{\textless{}{-}} \FunctionTok{subset}\NormalTok{(TV, }\AttributeTok{select =}\NormalTok{ Times, }\AttributeTok{subset =}\NormalTok{ Cable }\SpecialCharTok{==} \StringTok{"Basic"}\NormalTok{, }\AttributeTok{drop =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{times.Ext }\OtherTok{\textless{}{-}} \FunctionTok{subset}\NormalTok{(TV, }\AttributeTok{select =}\NormalTok{ Times, }\AttributeTok{subset =}\NormalTok{ Cable }\SpecialCharTok{==} \StringTok{"Extended"}\NormalTok{, }\AttributeTok{drop =} \ConstantTok{TRUE}\NormalTok{)}
...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{B)\{}
\NormalTok{  Basic.sample }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(times.Basic, }\AttributeTok{size =} \FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(times.Basic)), }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{  Ext.sample }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(times.Ext, }\AttributeTok{size =} \FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(times.Ext)), }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.43\textheight]{Week10_files/figure-beamer/unnamed-chunk-29-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.45\textheight]{Week10_files/figure-beamer/unnamed-chunk-30-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.38\textheight]{Week10_files/figure-beamer/unnamed-chunk-31-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-33-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.35\textheight]{Week10_files/figure-beamer/unnamed-chunk-35-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-38-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-40-1} \end{center}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-42-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-45-1} \end{center}
\normalsize
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.7\textheight]{Week10_files/figure-beamer/unnamed-chunk-47-1} \end{center}
\normalsize
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-49-1} \end{center}
...
\begin{tcolorbox}
Since $z_{1-\alpha/2}=z_{0.975}=1.959964$, we set $1.96\times \frac{24.6}{\sqrt{n}}\leq 5$. This leads to $n\geq  92.9878888$, so there should be at least 93 girls in the sample.
\end{tcolorbox}
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-52-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-53-1} \end{center}
\normalsize
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-54-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-55-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.5\textheight]{Week10_files/figure-beamer/unnamed-chunk-59-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.7\linewidth,height=0.5\textheight]{Week10_files/figure-beamer/unnamed-chunk-60-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_files/figure-beamer/unnamed-chunk-64-1} \end{center}
\normalsize
\end{frame}
...
\begin{center}\includegraphics[width=0.8\linewidth,height=0.5\textheight]{Week10_files/figure-beamer/unnamed-chunk-67-1} \end{center}
\normalsize
...
\begin{center}\includegraphics[width=0.8\linewidth,height=0.5\textheight]{Week10_files/figure-beamer/unnamed-chunk-69-1} \end{center}
\normalsize
