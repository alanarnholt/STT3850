...
\begin{center}\includegraphics[width=0.6\linewidth,height=0.4\textheight]{Week10_Lect_files/figure-beamer/unnamed-chunk-12-1} \end{center}
\normalsize
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{head}\NormalTok{(bowl\_sample\_1)}
\end{Highlighting}
\end{Shaded}
