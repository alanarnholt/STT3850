...
\phantomsection\label{by-the-end-of-the-week-foundations-of-probability}
\begin{itemize}
\tightlist
\item
  Laws of probability
...
\phantomsection\label{basics-of-probability}
\begin{itemize}
\item
...
\begin{frame}{Basics of probability}
\phantomsection\label{basics-of-probability-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{axioms-of-probability}
\begin{enumerate}
\item
  For any event \(E\):
...
\phantomsection\label{example-2-birthday-problem}
\begin{tcolorbox}
...
\begin{frame}{Example 2: Birthday Problem}
\phantomsection\label{example-2-birthday-problem-1}
\begin{tcolorbox}
Solution: 
...
\phantomsection\label{addition-rules-for-probability}
\begin{itemize}
\tightlist
\item
  If E and F can not happen happen at the same time (mutually exclusive
...
\phantomsection\label{multiplication-rules}
\begin{itemize}
\tightlist
\item
...
Rule}
\phantomsection\label{conditional-probability-and-the-general-multiplication-rule}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{definition-of-independence}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{law-of-total-probability-and-bayes-rule-1}
\begin{itemize}
\item
...
\phantomsection\label{example-1---partial-solution}
\begin{itemize}
...
\begin{frame}{Example 1 - Partial Solution}
\phantomsection\label{example-1---partial-solution-1}
...
\begin{frame}{Example 1 - Partial Solution}
\phantomsection\label{example-1---partial-solution-2}
If the document that was chosen at random was found to exceed 10 pages,
...
\begin{frame}{Example 1 - Partial Solution}
\phantomsection\label{example-1---partial-solution-3}
If the document that was chosen at random was found to exceed 10 pages,
...
\phantomsection\label{choose-a-door}
\begin{tcolorbox}
...
\phantomsection\label{choose-a-door-r-code}
\small
...
\phantomsection\label{choose-a-door-solution}
...
\begin{frame}{Choose a Door: Solution}
\phantomsection\label{choose-a-door-solution-1}
\begin{itemize}
...
\begin{frame}{Choose a Door: Solution}
\phantomsection\label{choose-a-door-solution-2}
\begin{equation*}
\begin{split}
...
\phantomsection\label{monte-hall-problem-with-n-doors}
\begin{itemize}
\item
...
\begin{frame}{Monte Hall Problem with \(n\) Doors}
\phantomsection\label{monte-hall-problem-with-n-doors-1}
