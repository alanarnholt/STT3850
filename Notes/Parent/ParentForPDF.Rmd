...
opts_chunk$set(comment = NA, cache = TRUE, fig.height = 5, fig.width = 5, message = FALSE, warning = FALSE, fig.align = 'center', tidy = TRUE, tidy.opts=list(keep.blank.line=FALSE, width.cutoff= 60))
```
