...
library(knitr)
opts_chunk$set(comment = NA, cache = FALSE, fig.height = 5, fig.width = 5, message = FALSE, warning = FALSE, fig.align = 'center', tidy = TRUE, tidy.opts=list(keep.blank.line=FALSE, width.cutoff= 60))
```
...
print(xtable(WD, caption = "All possible Samples of Size 3 from 3969, 3204, and 2892", digits = 0, align ="ccccc", label = "BT5"),  type = "latex", include.rownames=FALSE, sanitize.text.function=function(x){x}, add.to.row = list(pos = as.list(rws), command = col), booktabs = TRUE, comment = FALSE)
```
