...
- The $95\%$ bootstrap percentile interval is $(`r LL`, `r UL`)$ while the formula $t$ confidence interval is $(89.6834234, 160.956429)$
...
promotions %>% 
  ...
  calculate(stat = "diff in props", order = c("male", "female")) -> stuff
get_pvalue(stuff, obs_stat= .292, direction = "right") -> pv
pv
```
\normalsize
