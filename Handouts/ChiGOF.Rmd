...
There were a total of $n = `r sum(Observed)`$ players considered for this study, so the expected count for each quater is $528/4 = 132$.
...
## Example 3.9 - (There are a few typos in the book for this Example - including the conclusion)
